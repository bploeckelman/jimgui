...
public class ImGuiDebugAllocInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("TotalAllocCount"),
        cimgui_h.C_INT.withName("TotalFreeCount"),
        cimgui_h.C_SHORT.withName("LastEntriesIdx"),
    ...
    private static final long TotalAllocCount$OFFSET = $LAYOUT.byteOffset(groupElement("TotalAllocCount"));
    ...
    private static final long TotalFreeCount$OFFSET = $LAYOUT.byteOffset(groupElement("TotalFreeCount"));
    ...
    private static final long LastEntriesIdx$OFFSET = $LAYOUT.byteOffset(groupElement("LastEntriesIdx"));
    ...
    private static final long LastEntriesBuf$OFFSET = $LAYOUT.byteOffset(groupElement("LastEntriesBuf"));
    ...
    public static MemorySegment LastEntriesBuf(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)LastEntriesBuf$ELEM_HANDLE.invokeExact(struct, LastEntriesBuf$OFFSET, index0);
