...
public class ImGuiStoragePair {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("key"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            cimgui_h.C_INT.withName("val_i"),
            cimgui_h.C_FLOAT.withName("val_f"),
            cimgui_h.C_POINTER.withName("val_p")
        ).withName("$anon$1239:5")
    ...
    private static final OfInt val_i$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1239:5"), groupElement("val_i"));
    ...
    private static final long val_i$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1239:5"), groupElement("val_i"));
    ...
    private static final OfFloat val_f$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1239:5"), groupElement("val_f"));
    ...
    private static final long val_f$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1239:5"), groupElement("val_f"));
    ...
    private static final AddressLayout val_p$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$1239:5"), groupElement("val_p"));
    ...
    private static final long val_p$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1239:5"), groupElement("val_p"));
