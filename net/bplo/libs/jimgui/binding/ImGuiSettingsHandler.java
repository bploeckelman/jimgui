...
public class ImGuiSettingsHandler {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_POINTER.withName("TypeName"),
        cimgui_h.C_INT.withName("TypeHash"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("ClearAllFn"),
        cimgui_h.C_POINTER.withName("ReadInitFn"),
        cimgui_h.C_POINTER.withName("ReadOpenFn"),
        cimgui_h.C_POINTER.withName("ReadLineFn"),
        cimgui_h.C_POINTER.withName("ApplyAllFn"),
        cimgui_h.C_POINTER.withName("WriteAllFn"),
    ...
    private static final long TypeName$OFFSET = $LAYOUT.byteOffset(groupElement("TypeName"));
    ...
    private static final long TypeHash$OFFSET = $LAYOUT.byteOffset(groupElement("TypeHash"));
     ...
     * }
     */
    public final static class ClearAllFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(ClearAllFn.Function.class, "apply", $DESC);
    ...
    private static final long ClearAllFn$OFFSET = $LAYOUT.byteOffset(groupElement("ClearAllFn"));
     ...
     * }
     */
    public final static class ReadInitFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(ReadInitFn.Function.class, "apply", $DESC);
    ...
    private static final long ReadInitFn$OFFSET = $LAYOUT.byteOffset(groupElement("ReadInitFn"));
     ...
     * }
     */
    public final static class ReadOpenFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(ReadOpenFn.Function.class, "apply", $DESC);
    ...
    private static final long ReadOpenFn$OFFSET = $LAYOUT.byteOffset(groupElement("ReadOpenFn"));
     ...
     * }
     */
    public final static class ReadLineFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(ReadLineFn.Function.class, "apply", $DESC);
    ...
    private static final long ReadLineFn$OFFSET = $LAYOUT.byteOffset(groupElement("ReadLineFn"));
     ...
     * }
     */
    public final static class ApplyAllFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(ApplyAllFn.Function.class, "apply", $DESC);
    ...
    private static final long ApplyAllFn$OFFSET = $LAYOUT.byteOffset(groupElement("ApplyAllFn"));
     ...
     * }
     */
    public final static class WriteAllFn {
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(WriteAllFn.Function.class, "apply", $DESC);
    ...
    private static final long WriteAllFn$OFFSET = $LAYOUT.byteOffset(groupElement("WriteAllFn"));
