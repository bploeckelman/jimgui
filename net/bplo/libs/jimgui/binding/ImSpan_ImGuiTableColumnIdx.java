 ...
 * }
 */
public class ImSpan_ImGuiTableColumnIdx {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cimgui_h.C_POINTER.withName("DataEnd")
    ).withName("ImSpan_ImGuiTableColumnIdx");
    ...
    private static final long DataEnd$OFFSET = $LAYOUT.byteOffset(groupElement("DataEnd"));
