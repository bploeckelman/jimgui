...
public class ImGuiTableHeaderData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cimgui_h.C_INT.withName("TextColor"),
        cimgui_h.C_INT.withName("BgColor0"),
        cimgui_h.C_INT.withName("BgColor1")
    ...
    private static final long BgColor0$OFFSET = $LAYOUT.byteOffset(groupElement("BgColor0"));
    ...
    private static final long BgColor1$OFFSET = $LAYOUT.byteOffset(groupElement("BgColor1"));
