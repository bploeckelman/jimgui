...
public class ImGuiMenuColumns {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("TotalWidth"),
        cimgui_h.C_INT.withName("NextTotalWidth"),
        cimgui_h.C_SHORT.withName("Spacing"),
        cimgui_h.C_SHORT.withName("OffsetIcon"),
        cimgui_h.C_SHORT.withName("OffsetLabel"),
        cimgui_h.C_SHORT.withName("OffsetShortcut"),
        cimgui_h.C_SHORT.withName("OffsetMark"),
        MemoryLayout.sequenceLayout(4, cimgui_h.C_SHORT).withName("Widths"),
    ...
    private static final long TotalWidth$OFFSET = $LAYOUT.byteOffset(groupElement("TotalWidth"));
    ...
    private static final long NextTotalWidth$OFFSET = $LAYOUT.byteOffset(groupElement("NextTotalWidth"));
    ...
    private static final long OffsetIcon$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetIcon"));
    ...
    private static final long OffsetLabel$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetLabel"));
    ...
    private static final long OffsetShortcut$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetShortcut"));
    ...
    private static final long OffsetMark$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetMark"));
    ...
    private static final long Widths$OFFSET = $LAYOUT.byteOffset(groupElement("Widths"));
    ...
    public static short Widths(MemorySegment struct, long index0) {
        return (short)Widths$ELEM_HANDLE.get(struct, Widths$OFFSET, index0);
    }
    ...
    public static void Widths(MemorySegment struct, long index0, short fieldValue) {
        Widths$ELEM_HANDLE.set(struct, Widths$OFFSET, index0, fieldValue);
    }
