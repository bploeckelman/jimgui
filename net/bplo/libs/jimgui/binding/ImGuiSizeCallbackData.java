...
public class ImGuiSizeCallbackData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ImVec2_c.layout().withName("CurrentSize"),
        ImVec2_c.layout().withName("DesiredSize")
    ...
    private static final long CurrentSize$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentSize"));
    ...
    private static final long DesiredSize$OFFSET = $LAYOUT.byteOffset(groupElement("DesiredSize"));
