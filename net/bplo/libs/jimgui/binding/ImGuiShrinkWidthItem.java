...
public class ImGuiShrinkWidthItem {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("Index"),
        cimgui_h.C_FLOAT.withName("Width"),
        cimgui_h.C_FLOAT.withName("InitialWidth")
    ...
    private static final long InitialWidth$OFFSET = $LAYOUT.byteOffset(groupElement("InitialWidth"));
