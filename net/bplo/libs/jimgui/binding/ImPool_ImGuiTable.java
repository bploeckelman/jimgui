 ...
 * }
 */
public class ImPool_ImGuiTable {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ImVector_ImGuiTable.layout().withName("Buf"),
        ImGuiStorage.layout().withName("Map"),
        cimgui_h.C_INT.withName("FreeIdx"),
        cimgui_h.C_INT.withName("AliveCount")
    ).withName("ImPool_ImGuiTable");
    ...
    private static final long FreeIdx$OFFSET = $LAYOUT.byteOffset(groupElement("FreeIdx"));
    ...
    private static final long AliveCount$OFFSET = $LAYOUT.byteOffset(groupElement("AliveCount"));
