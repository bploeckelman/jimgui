 ...
 *     ImGuiID HookIdNext;
 *     const char *LocalizationTable[10];
 *     bool LogEnabled;
...
public class ImGuiContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_BOOL.withName("Initialized"),
        cimgui_h.C_BOOL.withName("WithinFrameScope"),
        cimgui_h.C_BOOL.withName("WithinFrameScopeWithImplicitWindow"),
        cimgui_h.C_BOOL.withName("TestEngineHookItems"),
        cimgui_h.C_INT.withName("FrameCount"),
        cimgui_h.C_INT.withName("FrameCountEnded"),
        cimgui_h.C_INT.withName("FrameCountRendered"),
        cimgui_h.C_DOUBLE.withName("Time"),
        MemoryLayout.sequenceLayout(16, cimgui_h.C_CHAR).withName("ContextName"),
        ImGuiIO.layout().withName("IO"),
        ImGuiPlatformIO.layout().withName("PlatformIO"),
        ImGuiStyle.layout().withName("Style"),
        ImVector_ImFontAtlasPtr.layout().withName("FontAtlases"),
        ...
        cimgui_h.C_FLOAT.withName("FontBakedScale"),
        cimgui_h.C_FLOAT.withName("FontRasterizerDensity"),
        cimgui_h.C_FLOAT.withName("CurrentDpiScale"),
        MemoryLayout.paddingLayout(4),
        ImDrawListSharedData.layout().withName("DrawListSharedData"),
        cimgui_h.C_INT.withName("WithinEndChildID"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("TestEngine"),
        ImVector_ImGuiInputEvent.layout().withName("InputEventsQueue"),
        ImVector_ImGuiInputEvent.layout().withName("InputEventsTrail"),
        cimgui_h.C_INT.withName("InputEventsNextMouseSource"),
        cimgui_h.C_INT.withName("InputEventsNextEventId"),
        ...
        cimgui_h.C_INT.withName("WindowsActiveCount"),
        cimgui_h.C_FLOAT.withName("WindowsBorderHoverPadding"),
        cimgui_h.C_INT.withName("DebugBreakInWindow"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("CurrentWindow"),
        cimgui_h.C_POINTER.withName("HoveredWindow"),
        cimgui_h.C_POINTER.withName("HoveredWindowUnderMovingWindow"),
        cimgui_h.C_POINTER.withName("HoveredWindowBeforeClear"),
        cimgui_h.C_POINTER.withName("MovingWindow"),
        cimgui_h.C_POINTER.withName("WheelingWindow"),
        ImVec2_c.layout().withName("WheelingWindowRefMousePos"),
        cimgui_h.C_INT.withName("WheelingWindowStartFrame"),
        cimgui_h.C_INT.withName("WheelingWindowScrolledFrame"),
        cimgui_h.C_FLOAT.withName("WheelingWindowReleaseTimer"),
        ImVec2_c.layout().withName("WheelingWindowWheelRemainder"),
        ImVec2_c.layout().withName("WheelingAxisAvg"),
        cimgui_h.C_INT.withName("DebugDrawIdConflictsId"),
        cimgui_h.C_INT.withName("DebugHookIdInfoId"),
        cimgui_h.C_INT.withName("HoveredId"),
        cimgui_h.C_INT.withName("HoveredIdPreviousFrame"),
        cimgui_h.C_INT.withName("HoveredIdPreviousFrameItemCount"),
        cimgui_h.C_FLOAT.withName("HoveredIdTimer"),
        cimgui_h.C_FLOAT.withName("HoveredIdNotActiveTimer"),
        cimgui_h.C_BOOL.withName("HoveredIdAllowOverlap"),
        cimgui_h.C_BOOL.withName("HoveredIdIsDisabled"),
        cimgui_h.C_BOOL.withName("ItemUnclipByLog"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_INT.withName("ActiveId"),
        cimgui_h.C_INT.withName("ActiveIdIsAlive"),
        cimgui_h.C_FLOAT.withName("ActiveIdTimer"),
        cimgui_h.C_BOOL.withName("ActiveIdIsJustActivated"),
        cimgui_h.C_BOOL.withName("ActiveIdAllowOverlap"),
        cimgui_h.C_BOOL.withName("ActiveIdNoClearOnFocusLoss"),
        cimgui_h.C_BOOL.withName("ActiveIdHasBeenPressedBefore"),
        cimgui_h.C_BOOL.withName("ActiveIdHasBeenEditedBefore"),
        cimgui_h.C_BOOL.withName("ActiveIdHasBeenEditedThisFrame"),
        cimgui_h.C_BOOL.withName("ActiveIdFromShortcut"),
        cimgui_h.C_CHAR.withName("ActiveIdMouseButton"),
        cimgui_h.C_INT.withName("ActiveIdDisabledId"),
        ImVec2_c.layout().withName("ActiveIdClickOffset"),
        cimgui_h.C_INT.withName("ActiveIdSource"),
        cimgui_h.C_POINTER.withName("ActiveIdWindow"),
        cimgui_h.C_INT.withName("ActiveIdPreviousFrame"),
        ImGuiDeactivatedItemData.layout().withName("DeactivatedItemData"),
        ImGuiDataTypeStorage.layout().withName("ActiveIdValueOnActivation"),
        cimgui_h.C_INT.withName("LastActiveId"),
        cimgui_h.C_FLOAT.withName("LastActiveIdTimer"),
        cimgui_h.C_DOUBLE.withName("LastKeyModsChangeTime"),
        cimgui_h.C_DOUBLE.withName("LastKeyModsChangeFromNoneTime"),
        cimgui_h.C_DOUBLE.withName("LastKeyboardKeyPressTime"),
        ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN.layout().withName("KeysMayBeCharInput"),
        MemoryLayout.sequenceLayout(155, ImGuiKeyOwnerData.layout()).withName("KeysOwnerData"),
        ImGuiKeyRoutingTable.layout().withName("KeysRoutingTable"),
        cimgui_h.C_INT.withName("ActiveIdUsingNavDirMask"),
        cimgui_h.C_BOOL.withName("ActiveIdUsingAllKeyboardKeys"),
        MemoryLayout.paddingLayout(3),
        cimgui_h.C_INT.withName("DebugBreakInShortcutRouting"),
        cimgui_h.C_INT.withName("CurrentFocusScopeId"),
        cimgui_h.C_INT.withName("CurrentItemFlags"),
        cimgui_h.C_INT.withName("DebugLocateId"),
        ...
        cimgui_h.C_BOOL.withName("DebugShowGroupRects"),
        cimgui_h.C_BOOL.withName("GcCompactAll"),
        MemoryLayout.paddingLayout(2),
        cimgui_h.C_INT.withName("DebugFlashStyleColorIdx"),
        ImVector_ImGuiColorMod.layout().withName("ColorStack"),
        ImVector_ImGuiStyleMod.layout().withName("StyleVarStack"),
        ImVector_ImFontStackData.layout().withName("FontStack"),
        ...
        cimgui_h.C_BOOL.withName("NavCursorVisible"),
        cimgui_h.C_BOOL.withName("NavHighlightItemUnderNav"),
        cimgui_h.C_BOOL.withName("NavMousePosDirty"),
        cimgui_h.C_BOOL.withName("NavIdIsAlive"),
        cimgui_h.C_INT.withName("NavId"),
        cimgui_h.C_POINTER.withName("NavWindow"),
        cimgui_h.C_INT.withName("NavFocusScopeId"),
        cimgui_h.C_INT.withName("NavLayer"),
        cimgui_h.C_INT.withName("NavActivateId"),
        cimgui_h.C_INT.withName("NavActivateDownId"),
        cimgui_h.C_INT.withName("NavActivatePressedId"),
        cimgui_h.C_INT.withName("NavActivateFlags"),
        ImVector_ImGuiFocusScopeData.layout().withName("NavFocusRoute"),
        cimgui_h.C_INT.withName("NavHighlightActivatedId"),
        cimgui_h.C_FLOAT.withName("NavHighlightActivatedTimer"),
        cimgui_h.C_INT.withName("NavNextActivateId"),
        cimgui_h.C_INT.withName("NavNextActivateFlags"),
        cimgui_h.C_INT.withName("NavInputSource"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_LONG_LONG.withName("NavLastValidSelectionUserData"),
        cimgui_h.C_CHAR.withName("NavCursorHideFrames"),
        cimgui_h.C_BOOL.withName("NavAnyRequest"),
        cimgui_h.C_BOOL.withName("NavInitRequest"),
        cimgui_h.C_BOOL.withName("NavInitRequestFromMove"),
        MemoryLayout.paddingLayout(4),
        ImGuiNavItemData.layout().withName("NavInitResult"),
        cimgui_h.C_BOOL.withName("NavMoveSubmitted"),
        cimgui_h.C_BOOL.withName("NavMoveScoringItems"),
        cimgui_h.C_BOOL.withName("NavMoveForwardToNextFrame"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_INT.withName("NavMoveFlags"),
        cimgui_h.C_INT.withName("NavMoveScrollFlags"),
        cimgui_h.C_INT.withName("NavMoveKeyMods"),
        cimgui_h.C_INT.withName("NavMoveDir"),
        cimgui_h.C_INT.withName("NavMoveDirForDebug"),
        cimgui_h.C_INT.withName("NavMoveClipDir"),
        ImRect_c.layout().withName("NavScoringRect"),
        ImRect_c.layout().withName("NavScoringNoClipRect"),
        cimgui_h.C_INT.withName("NavScoringDebugCount"),
        cimgui_h.C_INT.withName("NavTabbingDir"),
        cimgui_h.C_INT.withName("NavTabbingCounter"),
        ...
        cimgui_h.C_INT.withName("NavJustMovedFromFocusScopeId"),
        cimgui_h.C_INT.withName("NavJustMovedToId"),
        cimgui_h.C_INT.withName("NavJustMovedToFocusScopeId"),
        cimgui_h.C_INT.withName("NavJustMovedToKeyMods"),
        cimgui_h.C_BOOL.withName("NavJustMovedToIsTabbing"),
        cimgui_h.C_BOOL.withName("NavJustMovedToHasSelectionData"),
        cimgui_h.C_BOOL.withName("ConfigNavEnableTabbing"),
        cimgui_h.C_BOOL.withName("ConfigNavWindowingWithGamepad"),
        cimgui_h.C_INT.withName("ConfigNavWindowingKeyNext"),
        cimgui_h.C_INT.withName("ConfigNavWindowingKeyPrev"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("NavWindowingTarget"),
        cimgui_h.C_POINTER.withName("NavWindowingTargetAnim"),
        cimgui_h.C_POINTER.withName("NavWindowingListWindow"),
        cimgui_h.C_FLOAT.withName("NavWindowingTimer"),
        cimgui_h.C_FLOAT.withName("NavWindowingHighlightAlpha"),
        cimgui_h.C_INT.withName("NavWindowingInputSource"),
        cimgui_h.C_BOOL.withName("NavWindowingToggleLayer"),
        MemoryLayout.paddingLayout(3),
        cimgui_h.C_INT.withName("NavWindowingToggleKey"),
        ImVec2_c.layout().withName("NavWindowingAccumDeltaPos"),
        ImVec2_c.layout().withName("NavWindowingAccumDeltaSize"),
        cimgui_h.C_FLOAT.withName("DimBgRatio"),
        cimgui_h.C_BOOL.withName("DragDropActive"),
        cimgui_h.C_BOOL.withName("DragDropWithinSource"),
        cimgui_h.C_BOOL.withName("DragDropWithinTarget"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_INT.withName("DragDropSourceFlags"),
        cimgui_h.C_INT.withName("DragDropSourceFrameCount"),
        cimgui_h.C_INT.withName("DragDropMouseButton"),
        ImGuiPayload.layout().withName("DragDropPayload"),
        ImRect_c.layout().withName("DragDropTargetRect"),
        ImRect_c.layout().withName("DragDropTargetClipRect"),
        cimgui_h.C_INT.withName("DragDropTargetId"),
        cimgui_h.C_INT.withName("DragDropTargetFullViewport"),
        cimgui_h.C_INT.withName("DragDropAcceptFlagsCurr"),
        cimgui_h.C_INT.withName("DragDropAcceptFlagsPrev"),
        cimgui_h.C_FLOAT.withName("DragDropAcceptIdCurrRectSurface"),
        cimgui_h.C_INT.withName("DragDropAcceptIdCurr"),
        cimgui_h.C_INT.withName("DragDropAcceptIdPrev"),
        cimgui_h.C_INT.withName("DragDropAcceptFrameCount"),
        cimgui_h.C_INT.withName("DragDropHoldJustPressedId"),
        MemoryLayout.paddingLayout(4),
        ImVector_unsigned_char.layout().withName("DragDropPayloadBufHeap"),
        MemoryLayout.sequenceLayout(16, cimgui_h.C_CHAR).withName("DragDropPayloadBufLocal"),
        cimgui_h.C_INT.withName("ClipperTempDataStacked"),
        MemoryLayout.paddingLayout(4),
        ImVector_ImGuiListClipperData.layout().withName("ClipperTempData"),
        cimgui_h.C_POINTER.withName("CurrentTable"),
        cimgui_h.C_INT.withName("DebugBreakInTable"),
        cimgui_h.C_INT.withName("TablesTempDataStacked"),
        ...
        cimgui_h.C_POINTER.withName("CurrentTabBar"),
        ...
        cimgui_h.C_POINTER.withName("CurrentMultiSelect"),
        cimgui_h.C_INT.withName("MultiSelectTempDataStacked"),
        MemoryLayout.paddingLayout(4),
        ...
        cimgui_h.C_INT.withName("HoverItemDelayId"),
        cimgui_h.C_INT.withName("HoverItemDelayIdPreviousFrame"),
        cimgui_h.C_FLOAT.withName("HoverItemDelayTimer"),
        cimgui_h.C_FLOAT.withName("HoverItemDelayClearTimer"),
        cimgui_h.C_INT.withName("HoverItemUnlockedStationaryId"),
        cimgui_h.C_INT.withName("HoverWindowUnlockedStationaryId"),
        cimgui_h.C_INT.withName("MouseCursor"),
        cimgui_h.C_FLOAT.withName("MouseStationaryTimer"),
        ImVec2_c.layout().withName("MouseLastValidPos"),
        ImGuiInputTextState.layout().withName("InputTextState"),
        ImGuiTextIndex.layout().withName("InputTextLineIndex"),
        ImGuiInputTextDeactivatedState.layout().withName("InputTextDeactivatedState"),
        ImFontBaked.layout().withName("InputTextPasswordFontBackupBaked"),
        cimgui_h.C_INT.withName("InputTextPasswordFontBackupFlags"),
        cimgui_h.C_INT.withName("TempInputId"),
        ImGuiDataTypeStorage.layout().withName("DataTypeZeroValue"),
        cimgui_h.C_INT.withName("BeginMenuDepth"),
        cimgui_h.C_INT.withName("BeginComboDepth"),
        cimgui_h.C_INT.withName("ColorEditOptions"),
        cimgui_h.C_INT.withName("ColorEditCurrentID"),
        cimgui_h.C_INT.withName("ColorEditSavedID"),
        cimgui_h.C_FLOAT.withName("ColorEditSavedHue"),
        cimgui_h.C_FLOAT.withName("ColorEditSavedSat"),
        cimgui_h.C_INT.withName("ColorEditSavedColor"),
        ImVec4_c.layout().withName("ColorPickerRef"),
        ImGuiComboPreviewData.layout().withName("ComboPreviewData"),
        ImRect_c.layout().withName("WindowResizeBorderExpectedRect"),
        cimgui_h.C_BOOL.withName("WindowResizeRelativeMode"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_SHORT.withName("ScrollbarSeekMode"),
        cimgui_h.C_FLOAT.withName("ScrollbarClickDeltaToGrabCenter"),
        cimgui_h.C_FLOAT.withName("SliderGrabClickOffset"),
        cimgui_h.C_FLOAT.withName("SliderCurrentAccum"),
        cimgui_h.C_BOOL.withName("SliderCurrentAccumDirty"),
        cimgui_h.C_BOOL.withName("DragCurrentAccumDirty"),
        MemoryLayout.paddingLayout(2),
        cimgui_h.C_FLOAT.withName("DragCurrentAccum"),
        cimgui_h.C_FLOAT.withName("DragSpeedDefaultRatio"),
        cimgui_h.C_FLOAT.withName("DisabledAlphaBackup"),
        cimgui_h.C_SHORT.withName("DisabledStackSize"),
        cimgui_h.C_SHORT.withName("TooltipOverrideCount"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("TooltipPreviousWindow"),
        ...
        ImVector_ImTextureDataPtr.layout().withName("UserTextures"),
        cimgui_h.C_BOOL.withName("SettingsLoaded"),
        MemoryLayout.paddingLayout(3),
        cimgui_h.C_FLOAT.withName("SettingsDirtyTimer"),
        ...
        cimgui_h.C_INT.withName("HookIdNext"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.sequenceLayout(10, cimgui_h.C_POINTER).withName("LocalizationTable"),
        cimgui_h.C_BOOL.withName("LogEnabled"),
        cimgui_h.C_BOOL.withName("LogLineFirstItem"),
        MemoryLayout.paddingLayout(2),
        cimgui_h.C_INT.withName("LogFlags"),
        cimgui_h.C_POINTER.withName("LogWindow"),
        cimgui_h.C_POINTER.withName("LogFile"),
        ImGuiTextBuffer.layout().withName("LogBuffer"),
        cimgui_h.C_POINTER.withName("LogNextPrefix"),
        cimgui_h.C_POINTER.withName("LogNextSuffix"),
        cimgui_h.C_FLOAT.withName("LogLinePosY"),
        cimgui_h.C_INT.withName("LogDepthRef"),
        cimgui_h.C_INT.withName("LogDepthToExpand"),
        cimgui_h.C_INT.withName("LogDepthToExpandDefault"),
        cimgui_h.C_POINTER.withName("ErrorCallback"),
        cimgui_h.C_POINTER.withName("ErrorCallbackUserData"),
        ImVec2_c.layout().withName("ErrorTooltipLockedPos"),
        cimgui_h.C_BOOL.withName("ErrorFirst"),
        MemoryLayout.paddingLayout(3),
        cimgui_h.C_INT.withName("ErrorCountCurrentFrame"),
        ImGuiErrorRecoveryState.layout().withName("StackSizesInNewFrame"),
        MemoryLayout.paddingLayout(2),
        cimgui_h.C_POINTER.withName("StackSizesInBeginForCurrentWindow"),
        cimgui_h.C_INT.withName("DebugDrawIdConflictsCount"),
        cimgui_h.C_INT.withName("DebugLogFlags"),
        ImGuiTextBuffer.layout().withName("DebugLogBuf"),
        ImGuiTextIndex.layout().withName("DebugLogIndex"),
        cimgui_h.C_INT.withName("DebugLogSkippedErrors"),
        cimgui_h.C_INT.withName("DebugLogAutoDisableFlags"),
        cimgui_h.C_CHAR.withName("DebugLogAutoDisableFrames"),
        cimgui_h.C_CHAR.withName("DebugLocateFrames"),
        cimgui_h.C_BOOL.withName("DebugBreakInLocateId"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_INT.withName("DebugBreakKeyChord"),
        cimgui_h.C_CHAR.withName("DebugBeginReturnValueCullDepth"),
        cimgui_h.C_BOOL.withName("DebugItemPickerActive"),
        cimgui_h.C_CHAR.withName("DebugItemPickerMouseButton"),
        MemoryLayout.paddingLayout(1),
        cimgui_h.C_INT.withName("DebugItemPickerBreakId"),
        cimgui_h.C_FLOAT.withName("DebugFlashStyleColorTime"),
        ImVec4_c.layout().withName("DebugFlashStyleColorBackup"),
        ImGuiMetricsConfig.layout().withName("DebugMetricsConfig"),
        MemoryLayout.paddingLayout(4),
        ImGuiDebugItemPathQuery.layout().withName("DebugItemPathQuery"),
        ImGuiIDStackTool.layout().withName("DebugIDStackTool"),
        ImGuiDebugAllocInfo.layout().withName("DebugAllocInfo"),
        MemoryLayout.sequenceLayout(60, cimgui_h.C_FLOAT).withName("FramerateSecPerFrame"),
        cimgui_h.C_INT.withName("FramerateSecPerFrameIdx"),
        cimgui_h.C_INT.withName("FramerateSecPerFrameCount"),
        cimgui_h.C_FLOAT.withName("FramerateSecPerFrameAccum"),
        cimgui_h.C_INT.withName("WantCaptureMouseNextFrame"),
        cimgui_h.C_INT.withName("WantCaptureKeyboardNextFrame"),
        cimgui_h.C_INT.withName("WantTextInputNextFrame"),
        ImVector_char.layout().withName("TempBuffer"),
        MemoryLayout.sequenceLayout(64, cimgui_h.C_CHAR).withName("TempKeychordName")
    ...
    private static final long WithinFrameScope$OFFSET = $LAYOUT.byteOffset(groupElement("WithinFrameScope"));
    ...
    private static final long WithinFrameScopeWithImplicitWindow$OFFSET = $LAYOUT.byteOffset(groupElement("WithinFrameScopeWithImplicitWindow"));
    ...
    private static final long TestEngineHookItems$OFFSET = $LAYOUT.byteOffset(groupElement("TestEngineHookItems"));
    ...
    private static final long FrameCountEnded$OFFSET = $LAYOUT.byteOffset(groupElement("FrameCountEnded"));
    ...
    private static final long FrameCountRendered$OFFSET = $LAYOUT.byteOffset(groupElement("FrameCountRendered"));
    ...
    private static final long ContextName$OFFSET = $LAYOUT.byteOffset(groupElement("ContextName"));
    ...
    public static byte ContextName(MemorySegment struct, long index0) {
        return (byte)ContextName$ELEM_HANDLE.get(struct, ContextName$OFFSET, index0);
    }
    ...
    public static void ContextName(MemorySegment struct, long index0, byte fieldValue) {
        ContextName$ELEM_HANDLE.set(struct, ContextName$OFFSET, index0, fieldValue);
    }

    private static final GroupLayout IO_$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("IO"));
     ...
     * }
     */
    public static final GroupLayout IO_$layout() {
        return IO_$LAYOUT;
    }

    private static final long IO_$OFFSET = $LAYOUT.byteOffset(groupElement("IO"));
     ...
     * }
     */
    public static final long IO_$offset() {
        return IO_$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment IO_(MemorySegment struct) {
        return struct.asSlice(IO_$OFFSET, IO_$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void IO_(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, IO_$OFFSET, IO_$LAYOUT.byteSize());
    }
    ...
    private static final long PlatformIO$OFFSET = $LAYOUT.byteOffset(groupElement("PlatformIO"));
    ...
    private static final GroupLayout FontAtlases$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("FontAtlases"));
     ...
     * }
     */
    public static final GroupLayout FontAtlases$layout() {
        return FontAtlases$LAYOUT;
    }

    private static final long FontAtlases$OFFSET = $LAYOUT.byteOffset(groupElement("FontAtlases"));
     ...
     * }
     */
    public static final long FontAtlases$offset() {
        return FontAtlases$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment FontAtlases(MemorySegment struct) {
        return struct.asSlice(FontAtlases$OFFSET, FontAtlases$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void FontAtlases(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, FontAtlases$OFFSET, FontAtlases$LAYOUT.byteSize());
    }
    ...
    private static final OfFloat FontBakedScale$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("FontBakedScale"));
     ...
     * }
     */
    public static final OfFloat FontBakedScale$layout() {
        return FontBakedScale$LAYOUT;
    }

    private static final long FontBakedScale$OFFSET = $LAYOUT.byteOffset(groupElement("FontBakedScale"));
     ...
     * }
     */
    public static final long FontBakedScale$offset() {
        return FontBakedScale$OFFSET;
    }
     ...
     * }
     */
    public static float FontBakedScale(MemorySegment struct) {
        return struct.get(FontBakedScale$LAYOUT, FontBakedScale$OFFSET);
    }
     ...
     * }
     */
    public static void FontBakedScale(MemorySegment struct, float fieldValue) {
        struct.set(FontBakedScale$LAYOUT, FontBakedScale$OFFSET, fieldValue);
    }

    private static final OfFloat FontRasterizerDensity$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("FontRasterizerDensity"));
     ...
     * }
     */
    public static final OfFloat FontRasterizerDensity$layout() {
        return FontRasterizerDensity$LAYOUT;
    }

    private static final long FontRasterizerDensity$OFFSET = $LAYOUT.byteOffset(groupElement("FontRasterizerDensity"));
     ...
     * }
     */
    public static final long FontRasterizerDensity$offset() {
        return FontRasterizerDensity$OFFSET;
    }
     ...
     * }
     */
    public static float FontRasterizerDensity(MemorySegment struct) {
        return struct.get(FontRasterizerDensity$LAYOUT, FontRasterizerDensity$OFFSET);
    }
     ...
     * }
     */
    public static void FontRasterizerDensity(MemorySegment struct, float fieldValue) {
        struct.set(FontRasterizerDensity$LAYOUT, FontRasterizerDensity$OFFSET, fieldValue);
    }
    ...
    private static final long CurrentDpiScale$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentDpiScale"));
    ...
    private static final long DrawListSharedData$OFFSET = $LAYOUT.byteOffset(groupElement("DrawListSharedData"));
    ...
    private static final OfInt WithinEndChildID$LAYOUT = (OfInt)$LAYOUT.select(groupElement("WithinEndChildID"));
     ...
     * }
     */
    public static final OfInt WithinEndChildID$layout() {
        return WithinEndChildID$LAYOUT;
    }

    private static final long WithinEndChildID$OFFSET = $LAYOUT.byteOffset(groupElement("WithinEndChildID"));
     ...
     * }
     */
    public static final long WithinEndChildID$offset() {
        return WithinEndChildID$OFFSET;
    }
     ...
     * }
     */
    public static int WithinEndChildID(MemorySegment struct) {
        return struct.get(WithinEndChildID$LAYOUT, WithinEndChildID$OFFSET);
    }
     ...
     * }
     */
    public static void WithinEndChildID(MemorySegment struct, int fieldValue) {
        struct.set(WithinEndChildID$LAYOUT, WithinEndChildID$OFFSET, fieldValue);
    }
    ...
    private static final long TestEngine$OFFSET = $LAYOUT.byteOffset(groupElement("TestEngine"));
    ...
    private static final long InputEventsQueue$OFFSET = $LAYOUT.byteOffset(groupElement("InputEventsQueue"));
    ...
    private static final long InputEventsTrail$OFFSET = $LAYOUT.byteOffset(groupElement("InputEventsTrail"));
    ...
    private static final long InputEventsNextMouseSource$OFFSET = $LAYOUT.byteOffset(groupElement("InputEventsNextMouseSource"));
    ...
    private static final long InputEventsNextEventId$OFFSET = $LAYOUT.byteOffset(groupElement("InputEventsNextEventId"));
    ...
    private static final long WindowsFocusOrder$OFFSET = $LAYOUT.byteOffset(groupElement("WindowsFocusOrder"));
    ...
    private static final long WindowsTempSortBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("WindowsTempSortBuffer"));
    ...
    private static final long CurrentWindowStack$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentWindowStack"));
    ...
    private static final long WindowsById$OFFSET = $LAYOUT.byteOffset(groupElement("WindowsById"));
    ...
    private static final long WindowsActiveCount$OFFSET = $LAYOUT.byteOffset(groupElement("WindowsActiveCount"));
    ...
    private static final OfFloat WindowsBorderHoverPadding$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("WindowsBorderHoverPadding"));
     ...
     * }
     */
    public static final OfFloat WindowsBorderHoverPadding$layout() {
        return WindowsBorderHoverPadding$LAYOUT;
    }

    private static final long WindowsBorderHoverPadding$OFFSET = $LAYOUT.byteOffset(groupElement("WindowsBorderHoverPadding"));
     ...
     * }
     */
    public static final long WindowsBorderHoverPadding$offset() {
        return WindowsBorderHoverPadding$OFFSET;
    }
     ...
     * }
     */
    public static float WindowsBorderHoverPadding(MemorySegment struct) {
        return struct.get(WindowsBorderHoverPadding$LAYOUT, WindowsBorderHoverPadding$OFFSET);
    }
     ...
     * }
     */
    public static void WindowsBorderHoverPadding(MemorySegment struct, float fieldValue) {
        struct.set(WindowsBorderHoverPadding$LAYOUT, WindowsBorderHoverPadding$OFFSET, fieldValue);
    }
    ...
    private static final long DebugBreakInWindow$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBreakInWindow"));
    ...
    private static final long CurrentWindow$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentWindow"));
    ...
    private static final long HoveredWindow$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredWindow"));
    ...
    private static final long HoveredWindowUnderMovingWindow$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredWindowUnderMovingWindow"));
    ...
    private static final long HoveredWindowBeforeClear$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredWindowBeforeClear"));
    ...
    private static final long MovingWindow$OFFSET = $LAYOUT.byteOffset(groupElement("MovingWindow"));
    ...
    private static final long WheelingWindow$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindow"));
    ...
    private static final long WheelingWindowRefMousePos$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindowRefMousePos"));
    ...
    private static final long WheelingWindowStartFrame$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindowStartFrame"));
    ...
    private static final long WheelingWindowScrolledFrame$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindowScrolledFrame"));
    ...
    private static final long WheelingWindowReleaseTimer$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindowReleaseTimer"));
    ...
    private static final long WheelingWindowWheelRemainder$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingWindowWheelRemainder"));
    ...
    private static final long WheelingAxisAvg$OFFSET = $LAYOUT.byteOffset(groupElement("WheelingAxisAvg"));
    ...
    private static final OfInt DebugDrawIdConflictsId$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DebugDrawIdConflictsId"));
     ...
     * }
     */
    public static final OfInt DebugDrawIdConflictsId$layout() {
        return DebugDrawIdConflictsId$LAYOUT;
    }

    private static final long DebugDrawIdConflictsId$OFFSET = $LAYOUT.byteOffset(groupElement("DebugDrawIdConflictsId"));
     ...
     * }
     */
    public static final long DebugDrawIdConflictsId$offset() {
        return DebugDrawIdConflictsId$OFFSET;
    }
     ...
     * }
     */
    public static int DebugDrawIdConflictsId(MemorySegment struct) {
        return struct.get(DebugDrawIdConflictsId$LAYOUT, DebugDrawIdConflictsId$OFFSET);
    }
     ...
     * }
     */
    public static void DebugDrawIdConflictsId(MemorySegment struct, int fieldValue) {
        struct.set(DebugDrawIdConflictsId$LAYOUT, DebugDrawIdConflictsId$OFFSET, fieldValue);
    }

    private static final OfInt DebugHookIdInfoId$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DebugHookIdInfoId"));
     ...
     * }
     */
    public static final OfInt DebugHookIdInfoId$layout() {
        return DebugHookIdInfoId$LAYOUT;
    }

    private static final long DebugHookIdInfoId$OFFSET = $LAYOUT.byteOffset(groupElement("DebugHookIdInfoId"));
     ...
     * }
     */
    public static final long DebugHookIdInfoId$offset() {
        return DebugHookIdInfoId$OFFSET;
    }
     ...
     * }
     */
    public static int DebugHookIdInfoId(MemorySegment struct) {
        return struct.get(DebugHookIdInfoId$LAYOUT, DebugHookIdInfoId$OFFSET);
    }
     ...
     * }
     */
    public static void DebugHookIdInfoId(MemorySegment struct, int fieldValue) {
        struct.set(DebugHookIdInfoId$LAYOUT, DebugHookIdInfoId$OFFSET, fieldValue);
    }
    ...
    private static final long HoveredId$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredId"));
    ...
    private static final long HoveredIdPreviousFrame$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdPreviousFrame"));
    ...
    private static final OfInt HoveredIdPreviousFrameItemCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("HoveredIdPreviousFrameItemCount"));
     ...
     * }
     */
    public static final OfInt HoveredIdPreviousFrameItemCount$layout() {
        return HoveredIdPreviousFrameItemCount$LAYOUT;
    }

    private static final long HoveredIdPreviousFrameItemCount$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdPreviousFrameItemCount"));
     ...
     * }
     */
    public static final long HoveredIdPreviousFrameItemCount$offset() {
        return HoveredIdPreviousFrameItemCount$OFFSET;
    }
     ...
     * }
     */
    public static int HoveredIdPreviousFrameItemCount(MemorySegment struct) {
        return struct.get(HoveredIdPreviousFrameItemCount$LAYOUT, HoveredIdPreviousFrameItemCount$OFFSET);
    }
     ...
     * }
     */
    public static void HoveredIdPreviousFrameItemCount(MemorySegment struct, int fieldValue) {
        struct.set(HoveredIdPreviousFrameItemCount$LAYOUT, HoveredIdPreviousFrameItemCount$OFFSET, fieldValue);
    }
    ...
    private static final long HoveredIdTimer$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdTimer"));
    ...
    private static final long HoveredIdNotActiveTimer$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdNotActiveTimer"));
    ...
    private static final long HoveredIdAllowOverlap$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdAllowOverlap"));
    ...
    private static final long HoveredIdIsDisabled$OFFSET = $LAYOUT.byteOffset(groupElement("HoveredIdIsDisabled"));
    ...
    private static final long ItemUnclipByLog$OFFSET = $LAYOUT.byteOffset(groupElement("ItemUnclipByLog"));
    ...
    private static final long ActiveId$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveId"));
    ...
    private static final long ActiveIdIsAlive$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdIsAlive"));
    ...
    private static final long ActiveIdTimer$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdTimer"));
    ...
    private static final long ActiveIdIsJustActivated$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdIsJustActivated"));
    ...
    private static final long ActiveIdAllowOverlap$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdAllowOverlap"));
    ...
    private static final long ActiveIdNoClearOnFocusLoss$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdNoClearOnFocusLoss"));
    ...
    private static final long ActiveIdHasBeenPressedBefore$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdHasBeenPressedBefore"));
    ...
    private static final long ActiveIdHasBeenEditedBefore$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdHasBeenEditedBefore"));
    ...
    private static final long ActiveIdHasBeenEditedThisFrame$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdHasBeenEditedThisFrame"));
    ...
    private static final long ActiveIdFromShortcut$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdFromShortcut"));
    ...
    private static final OfByte ActiveIdMouseButton$LAYOUT = (OfByte)$LAYOUT.select(groupElement("ActiveIdMouseButton"));
     ...
     * }
     */
    public static final OfByte ActiveIdMouseButton$layout() {
        return ActiveIdMouseButton$LAYOUT;
    }

    private static final long ActiveIdMouseButton$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdMouseButton"));
     ...
     * }
     */
    public static final long ActiveIdMouseButton$offset() {
        return ActiveIdMouseButton$OFFSET;
    }
     ...
     * }
     */
    public static byte ActiveIdMouseButton(MemorySegment struct) {
        return struct.get(ActiveIdMouseButton$LAYOUT, ActiveIdMouseButton$OFFSET);
    }
     ...
     * }
     */
    public static void ActiveIdMouseButton(MemorySegment struct, byte fieldValue) {
        struct.set(ActiveIdMouseButton$LAYOUT, ActiveIdMouseButton$OFFSET, fieldValue);
    }

    private static final OfInt ActiveIdDisabledId$LAYOUT = (OfInt)$LAYOUT.select(groupElement("ActiveIdDisabledId"));
     ...
     * }
     */
    public static final OfInt ActiveIdDisabledId$layout() {
        return ActiveIdDisabledId$LAYOUT;
    }

    private static final long ActiveIdDisabledId$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdDisabledId"));
     ...
     * }
     */
    public static final long ActiveIdDisabledId$offset() {
        return ActiveIdDisabledId$OFFSET;
    }
     ...
     * }
     */
    public static int ActiveIdDisabledId(MemorySegment struct) {
        return struct.get(ActiveIdDisabledId$LAYOUT, ActiveIdDisabledId$OFFSET);
    }
     ...
     * }
     */
    public static void ActiveIdDisabledId(MemorySegment struct, int fieldValue) {
        struct.set(ActiveIdDisabledId$LAYOUT, ActiveIdDisabledId$OFFSET, fieldValue);
    }
    ...
    private static final long ActiveIdClickOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdClickOffset"));
    ...
    private static final long ActiveIdSource$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdSource"));
    ...
    private static final long ActiveIdWindow$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdWindow"));
    ...
    private static final long ActiveIdPreviousFrame$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdPreviousFrame"));
    ...
    private static final GroupLayout DeactivatedItemData$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("DeactivatedItemData"));
     ...
     * }
     */
    public static final GroupLayout DeactivatedItemData$layout() {
        return DeactivatedItemData$LAYOUT;
    }

    private static final long DeactivatedItemData$OFFSET = $LAYOUT.byteOffset(groupElement("DeactivatedItemData"));
     ...
     * }
     */
    public static final long DeactivatedItemData$offset() {
        return DeactivatedItemData$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment DeactivatedItemData(MemorySegment struct) {
        return struct.asSlice(DeactivatedItemData$OFFSET, DeactivatedItemData$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void DeactivatedItemData(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, DeactivatedItemData$OFFSET, DeactivatedItemData$LAYOUT.byteSize());
    }

    private static final GroupLayout ActiveIdValueOnActivation$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("ActiveIdValueOnActivation"));
     ...
     * }
     */
    public static final GroupLayout ActiveIdValueOnActivation$layout() {
        return ActiveIdValueOnActivation$LAYOUT;
    }

    private static final long ActiveIdValueOnActivation$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdValueOnActivation"));
     ...
     * }
     */
    public static final long ActiveIdValueOnActivation$offset() {
        return ActiveIdValueOnActivation$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ActiveIdValueOnActivation(MemorySegment struct) {
        return struct.asSlice(ActiveIdValueOnActivation$OFFSET, ActiveIdValueOnActivation$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void ActiveIdValueOnActivation(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, ActiveIdValueOnActivation$OFFSET, ActiveIdValueOnActivation$LAYOUT.byteSize());
    }
    ...
    private static final long LastActiveId$OFFSET = $LAYOUT.byteOffset(groupElement("LastActiveId"));
    ...
    private static final long LastActiveIdTimer$OFFSET = $LAYOUT.byteOffset(groupElement("LastActiveIdTimer"));
    ...
    private static final long LastKeyModsChangeTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastKeyModsChangeTime"));
    ...
    private static final long LastKeyModsChangeFromNoneTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastKeyModsChangeFromNoneTime"));
    ...
    private static final long LastKeyboardKeyPressTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastKeyboardKeyPressTime"));
    ...
    private static final long KeysMayBeCharInput$OFFSET = $LAYOUT.byteOffset(groupElement("KeysMayBeCharInput"));
    ...
    private static final long KeysOwnerData$OFFSET = $LAYOUT.byteOffset(groupElement("KeysOwnerData"));
    ...
    private static long[] KeysOwnerData$DIMS = { 155 };
    ...
    public static MemorySegment KeysOwnerData(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)KeysOwnerData$ELEM_HANDLE.invokeExact(struct, KeysOwnerData$OFFSET, index0);
    ...
    private static final long KeysRoutingTable$OFFSET = $LAYOUT.byteOffset(groupElement("KeysRoutingTable"));
    ...
    private static final long ActiveIdUsingNavDirMask$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdUsingNavDirMask"));
    ...
    private static final long ActiveIdUsingAllKeyboardKeys$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveIdUsingAllKeyboardKeys"));
    ...
    private static final long DebugBreakInShortcutRouting$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBreakInShortcutRouting"));
    ...
    private static final long CurrentFocusScopeId$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentFocusScopeId"));
    ...
    private static final long CurrentItemFlags$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentItemFlags"));
    ...
    private static final long DebugLocateId$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLocateId"));
    ...
    private static final long NextItemData$OFFSET = $LAYOUT.byteOffset(groupElement("NextItemData"));
    ...
    private static final long LastItemData$OFFSET = $LAYOUT.byteOffset(groupElement("LastItemData"));
    ...
    private static final long NextWindowData$OFFSET = $LAYOUT.byteOffset(groupElement("NextWindowData"));
    ...
    private static final long DebugShowGroupRects$OFFSET = $LAYOUT.byteOffset(groupElement("DebugShowGroupRects"));
    ...
    private static final long GcCompactAll$OFFSET = $LAYOUT.byteOffset(groupElement("GcCompactAll"));
    ...
    private static final long DebugFlashStyleColorIdx$OFFSET = $LAYOUT.byteOffset(groupElement("DebugFlashStyleColorIdx"));
    ...
    private static final long ColorStack$OFFSET = $LAYOUT.byteOffset(groupElement("ColorStack"));
    ...
    private static final long StyleVarStack$OFFSET = $LAYOUT.byteOffset(groupElement("StyleVarStack"));
    ...
    private static final long FontStack$OFFSET = $LAYOUT.byteOffset(groupElement("FontStack"));
    ...
    private static final long FocusScopeStack$OFFSET = $LAYOUT.byteOffset(groupElement("FocusScopeStack"));
    ...
    private static final long ItemFlagsStack$OFFSET = $LAYOUT.byteOffset(groupElement("ItemFlagsStack"));
    ...
    private static final long GroupStack$OFFSET = $LAYOUT.byteOffset(groupElement("GroupStack"));
    ...
    private static final long OpenPopupStack$OFFSET = $LAYOUT.byteOffset(groupElement("OpenPopupStack"));
    ...
    private static final long BeginPopupStack$OFFSET = $LAYOUT.byteOffset(groupElement("BeginPopupStack"));
    ...
    private static final long TreeNodeStack$OFFSET = $LAYOUT.byteOffset(groupElement("TreeNodeStack"));
    ...
    private static final long Viewports$OFFSET = $LAYOUT.byteOffset(groupElement("Viewports"));
    ...
    private static final OfBoolean NavCursorVisible$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("NavCursorVisible"));
     ...
     * }
     */
    public static final OfBoolean NavCursorVisible$layout() {
        return NavCursorVisible$LAYOUT;
    }

    private static final long NavCursorVisible$OFFSET = $LAYOUT.byteOffset(groupElement("NavCursorVisible"));
     ...
     * }
     */
    public static final long NavCursorVisible$offset() {
        return NavCursorVisible$OFFSET;
    }
     ...
     * }
     */
    public static boolean NavCursorVisible(MemorySegment struct) {
        return struct.get(NavCursorVisible$LAYOUT, NavCursorVisible$OFFSET);
    }
     ...
     * }
     */
    public static void NavCursorVisible(MemorySegment struct, boolean fieldValue) {
        struct.set(NavCursorVisible$LAYOUT, NavCursorVisible$OFFSET, fieldValue);
    }

    private static final OfBoolean NavHighlightItemUnderNav$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("NavHighlightItemUnderNav"));
     ...
     * }
     */
    public static final OfBoolean NavHighlightItemUnderNav$layout() {
        return NavHighlightItemUnderNav$LAYOUT;
    }

    private static final long NavHighlightItemUnderNav$OFFSET = $LAYOUT.byteOffset(groupElement("NavHighlightItemUnderNav"));
     ...
     * }
     */
    public static final long NavHighlightItemUnderNav$offset() {
        return NavHighlightItemUnderNav$OFFSET;
    }
     ...
     * }
     */
    public static boolean NavHighlightItemUnderNav(MemorySegment struct) {
        return struct.get(NavHighlightItemUnderNav$LAYOUT, NavHighlightItemUnderNav$OFFSET);
    }
     ...
     * }
     */
    public static void NavHighlightItemUnderNav(MemorySegment struct, boolean fieldValue) {
        struct.set(NavHighlightItemUnderNav$LAYOUT, NavHighlightItemUnderNav$OFFSET, fieldValue);
    }
    ...
    private static final long NavMousePosDirty$OFFSET = $LAYOUT.byteOffset(groupElement("NavMousePosDirty"));
    ...
    private static final long NavIdIsAlive$OFFSET = $LAYOUT.byteOffset(groupElement("NavIdIsAlive"));
    ...
    private static final long NavId$OFFSET = $LAYOUT.byteOffset(groupElement("NavId"));
    ...
    private static final long NavWindow$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindow"));
    ...
    private static final long NavFocusScopeId$OFFSET = $LAYOUT.byteOffset(groupElement("NavFocusScopeId"));
    ...
    private static final long NavLayer$OFFSET = $LAYOUT.byteOffset(groupElement("NavLayer"));
    ...
    private static final long NavActivateId$OFFSET = $LAYOUT.byteOffset(groupElement("NavActivateId"));
    ...
    private static final long NavActivateDownId$OFFSET = $LAYOUT.byteOffset(groupElement("NavActivateDownId"));
    ...
    private static final long NavActivatePressedId$OFFSET = $LAYOUT.byteOffset(groupElement("NavActivatePressedId"));
    ...
    private static final long NavActivateFlags$OFFSET = $LAYOUT.byteOffset(groupElement("NavActivateFlags"));
    ...
    private static final long NavFocusRoute$OFFSET = $LAYOUT.byteOffset(groupElement("NavFocusRoute"));
    ...
    private static final long NavHighlightActivatedId$OFFSET = $LAYOUT.byteOffset(groupElement("NavHighlightActivatedId"));
    ...
    private static final long NavHighlightActivatedTimer$OFFSET = $LAYOUT.byteOffset(groupElement("NavHighlightActivatedTimer"));
    ...
    private static final long NavNextActivateId$OFFSET = $LAYOUT.byteOffset(groupElement("NavNextActivateId"));
    ...
    private static final long NavNextActivateFlags$OFFSET = $LAYOUT.byteOffset(groupElement("NavNextActivateFlags"));
    ...
    private static final long NavInputSource$OFFSET = $LAYOUT.byteOffset(groupElement("NavInputSource"));
    ...
    private static final long NavLastValidSelectionUserData$OFFSET = $LAYOUT.byteOffset(groupElement("NavLastValidSelectionUserData"));
    ...
    private static final OfByte NavCursorHideFrames$LAYOUT = (OfByte)$LAYOUT.select(groupElement("NavCursorHideFrames"));
     ...
     * }
     */
    public static final OfByte NavCursorHideFrames$layout() {
        return NavCursorHideFrames$LAYOUT;
    }

    private static final long NavCursorHideFrames$OFFSET = $LAYOUT.byteOffset(groupElement("NavCursorHideFrames"));
     ...
     * }
     */
    public static final long NavCursorHideFrames$offset() {
        return NavCursorHideFrames$OFFSET;
    }
     ...
     * }
     */
    public static byte NavCursorHideFrames(MemorySegment struct) {
        return struct.get(NavCursorHideFrames$LAYOUT, NavCursorHideFrames$OFFSET);
    }
     ...
     * }
     */
    public static void NavCursorHideFrames(MemorySegment struct, byte fieldValue) {
        struct.set(NavCursorHideFrames$LAYOUT, NavCursorHideFrames$OFFSET, fieldValue);
    }
    ...
    private static final long NavAnyRequest$OFFSET = $LAYOUT.byteOffset(groupElement("NavAnyRequest"));
    ...
    private static final long NavInitRequest$OFFSET = $LAYOUT.byteOffset(groupElement("NavInitRequest"));
    ...
    private static final long NavInitRequestFromMove$OFFSET = $LAYOUT.byteOffset(groupElement("NavInitRequestFromMove"));
    ...
    private static final long NavInitResult$OFFSET = $LAYOUT.byteOffset(groupElement("NavInitResult"));
    ...
    private static final long NavMoveSubmitted$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveSubmitted"));
    ...
    private static final long NavMoveScoringItems$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveScoringItems"));
    ...
    private static final long NavMoveForwardToNextFrame$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveForwardToNextFrame"));
    ...
    private static final long NavMoveFlags$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveFlags"));
    ...
    private static final long NavMoveScrollFlags$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveScrollFlags"));
    ...
    private static final long NavMoveKeyMods$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveKeyMods"));
    ...
    private static final long NavMoveDir$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveDir"));
    ...
    private static final long NavMoveDirForDebug$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveDirForDebug"));
    ...
    private static final long NavMoveClipDir$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveClipDir"));
    ...
    private static final long NavScoringRect$OFFSET = $LAYOUT.byteOffset(groupElement("NavScoringRect"));
    ...
    private static final long NavScoringNoClipRect$OFFSET = $LAYOUT.byteOffset(groupElement("NavScoringNoClipRect"));
    ...
    private static final long NavScoringDebugCount$OFFSET = $LAYOUT.byteOffset(groupElement("NavScoringDebugCount"));
    ...
    private static final long NavTabbingDir$OFFSET = $LAYOUT.byteOffset(groupElement("NavTabbingDir"));
    ...
    private static final long NavTabbingCounter$OFFSET = $LAYOUT.byteOffset(groupElement("NavTabbingCounter"));
    ...
    private static final long NavMoveResultLocal$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveResultLocal"));
    ...
    private static final long NavMoveResultLocalVisible$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveResultLocalVisible"));
    ...
    private static final long NavMoveResultOther$OFFSET = $LAYOUT.byteOffset(groupElement("NavMoveResultOther"));
    ...
    private static final long NavTabbingResultFirst$OFFSET = $LAYOUT.byteOffset(groupElement("NavTabbingResultFirst"));
    ...
    private static final long NavJustMovedFromFocusScopeId$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedFromFocusScopeId"));
    ...
    private static final long NavJustMovedToId$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedToId"));
    ...
    private static final long NavJustMovedToFocusScopeId$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedToFocusScopeId"));
    ...
    private static final long NavJustMovedToKeyMods$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedToKeyMods"));
    ...
    private static final long NavJustMovedToIsTabbing$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedToIsTabbing"));
    ...
    private static final long NavJustMovedToHasSelectionData$OFFSET = $LAYOUT.byteOffset(groupElement("NavJustMovedToHasSelectionData"));
    ...
    private static final OfBoolean ConfigNavEnableTabbing$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("ConfigNavEnableTabbing"));
     ...
     * }
     */
    public static final OfBoolean ConfigNavEnableTabbing$layout() {
        return ConfigNavEnableTabbing$LAYOUT;
    }

    private static final long ConfigNavEnableTabbing$OFFSET = $LAYOUT.byteOffset(groupElement("ConfigNavEnableTabbing"));
     ...
     * }
     */
    public static final long ConfigNavEnableTabbing$offset() {
        return ConfigNavEnableTabbing$OFFSET;
    }
     ...
     * }
     */
    public static boolean ConfigNavEnableTabbing(MemorySegment struct) {
        return struct.get(ConfigNavEnableTabbing$LAYOUT, ConfigNavEnableTabbing$OFFSET);
    }
     ...
     * }
     */
    public static void ConfigNavEnableTabbing(MemorySegment struct, boolean fieldValue) {
        struct.set(ConfigNavEnableTabbing$LAYOUT, ConfigNavEnableTabbing$OFFSET, fieldValue);
    }

    private static final OfBoolean ConfigNavWindowingWithGamepad$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("ConfigNavWindowingWithGamepad"));
     ...
     * }
     */
    public static final OfBoolean ConfigNavWindowingWithGamepad$layout() {
        return ConfigNavWindowingWithGamepad$LAYOUT;
    }

    private static final long ConfigNavWindowingWithGamepad$OFFSET = $LAYOUT.byteOffset(groupElement("ConfigNavWindowingWithGamepad"));
     ...
     * }
     */
    public static final long ConfigNavWindowingWithGamepad$offset() {
        return ConfigNavWindowingWithGamepad$OFFSET;
    }
     ...
     * }
     */
    public static boolean ConfigNavWindowingWithGamepad(MemorySegment struct) {
        return struct.get(ConfigNavWindowingWithGamepad$LAYOUT, ConfigNavWindowingWithGamepad$OFFSET);
    }
     ...
     * }
     */
    public static void ConfigNavWindowingWithGamepad(MemorySegment struct, boolean fieldValue) {
        struct.set(ConfigNavWindowingWithGamepad$LAYOUT, ConfigNavWindowingWithGamepad$OFFSET, fieldValue);
    }
    ...
    private static final long ConfigNavWindowingKeyNext$OFFSET = $LAYOUT.byteOffset(groupElement("ConfigNavWindowingKeyNext"));
    ...
    private static final long ConfigNavWindowingKeyPrev$OFFSET = $LAYOUT.byteOffset(groupElement("ConfigNavWindowingKeyPrev"));
    ...
    private static final long NavWindowingTarget$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingTarget"));
    ...
    private static final long NavWindowingTargetAnim$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingTargetAnim"));
    ...
    private static final long NavWindowingListWindow$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingListWindow"));
    ...
    private static final long NavWindowingTimer$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingTimer"));
    ...
    private static final long NavWindowingHighlightAlpha$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingHighlightAlpha"));
    ...
    private static final OfInt NavWindowingInputSource$LAYOUT = (OfInt)$LAYOUT.select(groupElement("NavWindowingInputSource"));
     ...
     * }
     */
    public static final OfInt NavWindowingInputSource$layout() {
        return NavWindowingInputSource$LAYOUT;
    }

    private static final long NavWindowingInputSource$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingInputSource"));
     ...
     * }
     */
    public static final long NavWindowingInputSource$offset() {
        return NavWindowingInputSource$OFFSET;
    }
     ...
     * }
     */
    public static int NavWindowingInputSource(MemorySegment struct) {
        return struct.get(NavWindowingInputSource$LAYOUT, NavWindowingInputSource$OFFSET);
    }
     ...
     * }
     */
    public static void NavWindowingInputSource(MemorySegment struct, int fieldValue) {
        struct.set(NavWindowingInputSource$LAYOUT, NavWindowingInputSource$OFFSET, fieldValue);
    }
    ...
    private static final long NavWindowingToggleLayer$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingToggleLayer"));
    ...
    private static final long NavWindowingToggleKey$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingToggleKey"));
    ...
    private static final long NavWindowingAccumDeltaPos$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingAccumDeltaPos"));
    ...
    private static final long NavWindowingAccumDeltaSize$OFFSET = $LAYOUT.byteOffset(groupElement("NavWindowingAccumDeltaSize"));
    ...
    private static final long DimBgRatio$OFFSET = $LAYOUT.byteOffset(groupElement("DimBgRatio"));
    ...
    private static final long DragDropActive$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropActive"));
    ...
    private static final long DragDropWithinSource$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropWithinSource"));
    ...
    private static final long DragDropWithinTarget$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropWithinTarget"));
    ...
    private static final long DragDropSourceFlags$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropSourceFlags"));
    ...
    private static final long DragDropSourceFrameCount$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropSourceFrameCount"));
    ...
    private static final long DragDropMouseButton$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropMouseButton"));
    ...
    private static final long DragDropPayload$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropPayload"));
    ...
    private static final long DragDropTargetRect$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropTargetRect"));
    ...
    private static final long DragDropTargetClipRect$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropTargetClipRect"));
    ...
    private static final long DragDropTargetId$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropTargetId"));
    ...
    private static final OfInt DragDropTargetFullViewport$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DragDropTargetFullViewport"));
     ...
     * }
     */
    public static final OfInt DragDropTargetFullViewport$layout() {
        return DragDropTargetFullViewport$LAYOUT;
    }

    private static final long DragDropTargetFullViewport$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropTargetFullViewport"));
     ...
     * }
     */
    public static final long DragDropTargetFullViewport$offset() {
        return DragDropTargetFullViewport$OFFSET;
    }
     ...
     * }
     */
    public static int DragDropTargetFullViewport(MemorySegment struct) {
        return struct.get(DragDropTargetFullViewport$LAYOUT, DragDropTargetFullViewport$OFFSET);
    }
     ...
     * }
     */
    public static void DragDropTargetFullViewport(MemorySegment struct, int fieldValue) {
        struct.set(DragDropTargetFullViewport$LAYOUT, DragDropTargetFullViewport$OFFSET, fieldValue);
    }

    private static final OfInt DragDropAcceptFlagsCurr$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DragDropAcceptFlagsCurr"));
     ...
     * }
     */
    public static final OfInt DragDropAcceptFlagsCurr$layout() {
        return DragDropAcceptFlagsCurr$LAYOUT;
    }

    private static final long DragDropAcceptFlagsCurr$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptFlagsCurr"));
     ...
     * }
     */
    public static final long DragDropAcceptFlagsCurr$offset() {
        return DragDropAcceptFlagsCurr$OFFSET;
    }
     ...
     * }
     */
    public static int DragDropAcceptFlagsCurr(MemorySegment struct) {
        return struct.get(DragDropAcceptFlagsCurr$LAYOUT, DragDropAcceptFlagsCurr$OFFSET);
    }
     ...
     * }
     */
    public static void DragDropAcceptFlagsCurr(MemorySegment struct, int fieldValue) {
        struct.set(DragDropAcceptFlagsCurr$LAYOUT, DragDropAcceptFlagsCurr$OFFSET, fieldValue);
    }

    private static final OfInt DragDropAcceptFlagsPrev$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DragDropAcceptFlagsPrev"));
     ...
     * }
     */
    public static final OfInt DragDropAcceptFlagsPrev$layout() {
        return DragDropAcceptFlagsPrev$LAYOUT;
    }

    private static final long DragDropAcceptFlagsPrev$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptFlagsPrev"));
     ...
     * }
     */
    public static final long DragDropAcceptFlagsPrev$offset() {
        return DragDropAcceptFlagsPrev$OFFSET;
    }
     ...
     * }
     */
    public static int DragDropAcceptFlagsPrev(MemorySegment struct) {
        return struct.get(DragDropAcceptFlagsPrev$LAYOUT, DragDropAcceptFlagsPrev$OFFSET);
    }
     ...
     * }
     */
    public static void DragDropAcceptFlagsPrev(MemorySegment struct, int fieldValue) {
        struct.set(DragDropAcceptFlagsPrev$LAYOUT, DragDropAcceptFlagsPrev$OFFSET, fieldValue);
    }
    ...
    private static final long DragDropAcceptIdCurrRectSurface$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptIdCurrRectSurface"));
    ...
    private static final long DragDropAcceptIdCurr$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptIdCurr"));
    ...
    private static final long DragDropAcceptIdPrev$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptIdPrev"));
    ...
    private static final long DragDropAcceptFrameCount$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropAcceptFrameCount"));
    ...
    private static final long DragDropHoldJustPressedId$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropHoldJustPressedId"));
    ...
    private static final long DragDropPayloadBufHeap$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropPayloadBufHeap"));
    ...
    private static final long DragDropPayloadBufLocal$OFFSET = $LAYOUT.byteOffset(groupElement("DragDropPayloadBufLocal"));
    ...
    public static byte DragDropPayloadBufLocal(MemorySegment struct, long index0) {
        return (byte)DragDropPayloadBufLocal$ELEM_HANDLE.get(struct, DragDropPayloadBufLocal$OFFSET, index0);
    }
    ...
    public static void DragDropPayloadBufLocal(MemorySegment struct, long index0, byte fieldValue) {
        DragDropPayloadBufLocal$ELEM_HANDLE.set(struct, DragDropPayloadBufLocal$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ClipperTempDataStacked$OFFSET = $LAYOUT.byteOffset(groupElement("ClipperTempDataStacked"));
    ...
    private static final long ClipperTempData$OFFSET = $LAYOUT.byteOffset(groupElement("ClipperTempData"));
    ...
    private static final long CurrentTable$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentTable"));
    ...
    private static final long DebugBreakInTable$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBreakInTable"));
    ...
    private static final long TablesTempDataStacked$OFFSET = $LAYOUT.byteOffset(groupElement("TablesTempDataStacked"));
    ...
    private static final long TablesTempData$OFFSET = $LAYOUT.byteOffset(groupElement("TablesTempData"));
    ...
    private static final long TablesLastTimeActive$OFFSET = $LAYOUT.byteOffset(groupElement("TablesLastTimeActive"));
    ...
    private static final long DrawChannelsTempMergeBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("DrawChannelsTempMergeBuffer"));
    ...
    private static final long CurrentTabBar$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentTabBar"));
    ...
    private static final long TabBars$OFFSET = $LAYOUT.byteOffset(groupElement("TabBars"));
    ...
    private static final long CurrentTabBarStack$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentTabBarStack"));
    ...
    private static final long ShrinkWidthBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("ShrinkWidthBuffer"));
    ...
    private static final long BoxSelectState$OFFSET = $LAYOUT.byteOffset(groupElement("BoxSelectState"));
    ...
    private static final long CurrentMultiSelect$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentMultiSelect"));
    ...
    private static final long MultiSelectTempDataStacked$OFFSET = $LAYOUT.byteOffset(groupElement("MultiSelectTempDataStacked"));
    ...
    private static final long MultiSelectTempData$OFFSET = $LAYOUT.byteOffset(groupElement("MultiSelectTempData"));
    ...
    private static final long MultiSelectStorage$OFFSET = $LAYOUT.byteOffset(groupElement("MultiSelectStorage"));
    ...
    private static final long HoverItemDelayId$OFFSET = $LAYOUT.byteOffset(groupElement("HoverItemDelayId"));
    ...
    private static final long HoverItemDelayIdPreviousFrame$OFFSET = $LAYOUT.byteOffset(groupElement("HoverItemDelayIdPreviousFrame"));
    ...
    private static final long HoverItemDelayTimer$OFFSET = $LAYOUT.byteOffset(groupElement("HoverItemDelayTimer"));
    ...
    private static final long HoverItemDelayClearTimer$OFFSET = $LAYOUT.byteOffset(groupElement("HoverItemDelayClearTimer"));
    ...
    private static final long HoverItemUnlockedStationaryId$OFFSET = $LAYOUT.byteOffset(groupElement("HoverItemUnlockedStationaryId"));
    ...
    private static final long HoverWindowUnlockedStationaryId$OFFSET = $LAYOUT.byteOffset(groupElement("HoverWindowUnlockedStationaryId"));
    ...
    private static final long MouseCursor$OFFSET = $LAYOUT.byteOffset(groupElement("MouseCursor"));
    ...
    private static final long MouseStationaryTimer$OFFSET = $LAYOUT.byteOffset(groupElement("MouseStationaryTimer"));
    ...
    private static final long MouseLastValidPos$OFFSET = $LAYOUT.byteOffset(groupElement("MouseLastValidPos"));
    ...
    private static final long InputTextState$OFFSET = $LAYOUT.byteOffset(groupElement("InputTextState"));
    ...
    private static final GroupLayout InputTextLineIndex$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("InputTextLineIndex"));
     ...
     * }
     */
    public static final GroupLayout InputTextLineIndex$layout() {
        return InputTextLineIndex$LAYOUT;
    }

    private static final long InputTextLineIndex$OFFSET = $LAYOUT.byteOffset(groupElement("InputTextLineIndex"));
     ...
     * }
     */
    public static final long InputTextLineIndex$offset() {
        return InputTextLineIndex$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment InputTextLineIndex(MemorySegment struct) {
        return struct.asSlice(InputTextLineIndex$OFFSET, InputTextLineIndex$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void InputTextLineIndex(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, InputTextLineIndex$OFFSET, InputTextLineIndex$LAYOUT.byteSize());
    }
    ...
    private static final long InputTextDeactivatedState$OFFSET = $LAYOUT.byteOffset(groupElement("InputTextDeactivatedState"));
    ...
    private static final GroupLayout InputTextPasswordFontBackupBaked$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("InputTextPasswordFontBackupBaked"));
     ...
     * }
     */
    public static final GroupLayout InputTextPasswordFontBackupBaked$layout() {
        return InputTextPasswordFontBackupBaked$LAYOUT;
    }

    private static final long InputTextPasswordFontBackupBaked$OFFSET = $LAYOUT.byteOffset(groupElement("InputTextPasswordFontBackupBaked"));
     ...
     * }
     */
    public static final long InputTextPasswordFontBackupBaked$offset() {
        return InputTextPasswordFontBackupBaked$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment InputTextPasswordFontBackupBaked(MemorySegment struct) {
        return struct.asSlice(InputTextPasswordFontBackupBaked$OFFSET, InputTextPasswordFontBackupBaked$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void InputTextPasswordFontBackupBaked(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, InputTextPasswordFontBackupBaked$OFFSET, InputTextPasswordFontBackupBaked$LAYOUT.byteSize());
    }

    private static final OfInt InputTextPasswordFontBackupFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("InputTextPasswordFontBackupFlags"));
     ...
     * }
     */
    public static final OfInt InputTextPasswordFontBackupFlags$layout() {
        return InputTextPasswordFontBackupFlags$LAYOUT;
    }

    private static final long InputTextPasswordFontBackupFlags$OFFSET = $LAYOUT.byteOffset(groupElement("InputTextPasswordFontBackupFlags"));
     ...
     * }
     */
    public static final long InputTextPasswordFontBackupFlags$offset() {
        return InputTextPasswordFontBackupFlags$OFFSET;
    }
     ...
     * }
     */
    public static int InputTextPasswordFontBackupFlags(MemorySegment struct) {
        return struct.get(InputTextPasswordFontBackupFlags$LAYOUT, InputTextPasswordFontBackupFlags$OFFSET);
    }
     ...
     * }
     */
    public static void InputTextPasswordFontBackupFlags(MemorySegment struct, int fieldValue) {
        struct.set(InputTextPasswordFontBackupFlags$LAYOUT, InputTextPasswordFontBackupFlags$OFFSET, fieldValue);
    }
    ...
    private static final long TempInputId$OFFSET = $LAYOUT.byteOffset(groupElement("TempInputId"));
    ...
    private static final long DataTypeZeroValue$OFFSET = $LAYOUT.byteOffset(groupElement("DataTypeZeroValue"));
    ...
    private static final long BeginMenuDepth$OFFSET = $LAYOUT.byteOffset(groupElement("BeginMenuDepth"));
    ...
    private static final long BeginComboDepth$OFFSET = $LAYOUT.byteOffset(groupElement("BeginComboDepth"));
    ...
    private static final long ColorEditOptions$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditOptions"));
    ...
    private static final long ColorEditCurrentID$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditCurrentID"));
    ...
    private static final long ColorEditSavedID$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditSavedID"));
    ...
    private static final long ColorEditSavedHue$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditSavedHue"));
    ...
    private static final long ColorEditSavedSat$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditSavedSat"));
    ...
    private static final long ColorEditSavedColor$OFFSET = $LAYOUT.byteOffset(groupElement("ColorEditSavedColor"));
    ...
    private static final long ColorPickerRef$OFFSET = $LAYOUT.byteOffset(groupElement("ColorPickerRef"));
    ...
    private static final long ComboPreviewData$OFFSET = $LAYOUT.byteOffset(groupElement("ComboPreviewData"));
    ...
    private static final long WindowResizeBorderExpectedRect$OFFSET = $LAYOUT.byteOffset(groupElement("WindowResizeBorderExpectedRect"));
    ...
    private static final long WindowResizeRelativeMode$OFFSET = $LAYOUT.byteOffset(groupElement("WindowResizeRelativeMode"));
    ...
    private static final long ScrollbarSeekMode$OFFSET = $LAYOUT.byteOffset(groupElement("ScrollbarSeekMode"));
    ...
    private static final long ScrollbarClickDeltaToGrabCenter$OFFSET = $LAYOUT.byteOffset(groupElement("ScrollbarClickDeltaToGrabCenter"));
    ...
    private static final long SliderGrabClickOffset$OFFSET = $LAYOUT.byteOffset(groupElement("SliderGrabClickOffset"));
    ...
    private static final long SliderCurrentAccum$OFFSET = $LAYOUT.byteOffset(groupElement("SliderCurrentAccum"));
    ...
    private static final long SliderCurrentAccumDirty$OFFSET = $LAYOUT.byteOffset(groupElement("SliderCurrentAccumDirty"));
    ...
    private static final long DragCurrentAccumDirty$OFFSET = $LAYOUT.byteOffset(groupElement("DragCurrentAccumDirty"));
    ...
    private static final long DragCurrentAccum$OFFSET = $LAYOUT.byteOffset(groupElement("DragCurrentAccum"));
    ...
    private static final long DragSpeedDefaultRatio$OFFSET = $LAYOUT.byteOffset(groupElement("DragSpeedDefaultRatio"));
    ...
    private static final long DisabledAlphaBackup$OFFSET = $LAYOUT.byteOffset(groupElement("DisabledAlphaBackup"));
    ...
    private static final long DisabledStackSize$OFFSET = $LAYOUT.byteOffset(groupElement("DisabledStackSize"));
    ...
    private static final long TooltipOverrideCount$OFFSET = $LAYOUT.byteOffset(groupElement("TooltipOverrideCount"));
    ...
    private static final AddressLayout TooltipPreviousWindow$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("TooltipPreviousWindow"));
     ...
     * }
     */
    public static final AddressLayout TooltipPreviousWindow$layout() {
        return TooltipPreviousWindow$LAYOUT;
    }

    private static final long TooltipPreviousWindow$OFFSET = $LAYOUT.byteOffset(groupElement("TooltipPreviousWindow"));
     ...
     * }
     */
    public static final long TooltipPreviousWindow$offset() {
        return TooltipPreviousWindow$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment TooltipPreviousWindow(MemorySegment struct) {
        return struct.get(TooltipPreviousWindow$LAYOUT, TooltipPreviousWindow$OFFSET);
    }
     ...
     * }
     */
    public static void TooltipPreviousWindow(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(TooltipPreviousWindow$LAYOUT, TooltipPreviousWindow$OFFSET, fieldValue);
    }
    ...
    private static final long ClipboardHandlerData$OFFSET = $LAYOUT.byteOffset(groupElement("ClipboardHandlerData"));
    ...
    private static final long MenusIdSubmittedThisFrame$OFFSET = $LAYOUT.byteOffset(groupElement("MenusIdSubmittedThisFrame"));
    ...
    private static final long TypingSelectState$OFFSET = $LAYOUT.byteOffset(groupElement("TypingSelectState"));
    ...
    private static final long PlatformImeData$OFFSET = $LAYOUT.byteOffset(groupElement("PlatformImeData"));
    ...
    private static final long PlatformImeDataPrev$OFFSET = $LAYOUT.byteOffset(groupElement("PlatformImeDataPrev"));
    ...
    private static final GroupLayout UserTextures$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("UserTextures"));
     ...
     * }
     */
    public static final GroupLayout UserTextures$layout() {
        return UserTextures$LAYOUT;
    }

    private static final long UserTextures$OFFSET = $LAYOUT.byteOffset(groupElement("UserTextures"));
     ...
     * }
     */
    public static final long UserTextures$offset() {
        return UserTextures$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment UserTextures(MemorySegment struct) {
        return struct.asSlice(UserTextures$OFFSET, UserTextures$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void UserTextures(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, UserTextures$OFFSET, UserTextures$LAYOUT.byteSize());
    }
    ...
    private static final long SettingsLoaded$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsLoaded"));
    ...
    private static final long SettingsDirtyTimer$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsDirtyTimer"));
    ...
    private static final long SettingsIniData$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsIniData"));
    ...
    private static final long SettingsHandlers$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsHandlers"));
    ...
    private static final long SettingsWindows$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsWindows"));
    ...
    private static final long SettingsTables$OFFSET = $LAYOUT.byteOffset(groupElement("SettingsTables"));
    ...
    private static final long HookIdNext$OFFSET = $LAYOUT.byteOffset(groupElement("HookIdNext"));
    ...
    private static final long LocalizationTable$OFFSET = $LAYOUT.byteOffset(groupElement("LocalizationTable"));
    ...
    private static long[] LocalizationTable$DIMS = { 10 };
    ...
    public static MemorySegment LocalizationTable(MemorySegment struct, long index0) {
        return (MemorySegment)LocalizationTable$ELEM_HANDLE.get(struct, LocalizationTable$OFFSET, index0);
    }
    ...
    public static void LocalizationTable(MemorySegment struct, long index0, MemorySegment fieldValue) {
        LocalizationTable$ELEM_HANDLE.set(struct, LocalizationTable$OFFSET, index0, fieldValue);
    }
    ...
    private static final long LogEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("LogEnabled"));
    ...
    private static final long LogLineFirstItem$OFFSET = $LAYOUT.byteOffset(groupElement("LogLineFirstItem"));
    ...
    private static final OfInt LogFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("LogFlags"));
     ...
     * }
     */
    public static final OfInt LogFlags$layout() {
        return LogFlags$LAYOUT;
    }

    private static final long LogFlags$OFFSET = $LAYOUT.byteOffset(groupElement("LogFlags"));
     ...
     * }
     */
    public static final long LogFlags$offset() {
        return LogFlags$OFFSET;
    }
     ...
     * }
     */
    public static int LogFlags(MemorySegment struct) {
        return struct.get(LogFlags$LAYOUT, LogFlags$OFFSET);
    }
     ...
     * }
     */
    public static void LogFlags(MemorySegment struct, int fieldValue) {
        struct.set(LogFlags$LAYOUT, LogFlags$OFFSET, fieldValue);
    }

    private static final AddressLayout LogWindow$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("LogWindow"));
     ...
     * }
     */
    public static final AddressLayout LogWindow$layout() {
        return LogWindow$LAYOUT;
    }

    private static final long LogWindow$OFFSET = $LAYOUT.byteOffset(groupElement("LogWindow"));
     ...
     * }
     */
    public static final long LogWindow$offset() {
        return LogWindow$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment LogWindow(MemorySegment struct) {
        return struct.get(LogWindow$LAYOUT, LogWindow$OFFSET);
    }
     ...
     * }
     */
    public static void LogWindow(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(LogWindow$LAYOUT, LogWindow$OFFSET, fieldValue);
    }
    ...
    private static final long LogFile$OFFSET = $LAYOUT.byteOffset(groupElement("LogFile"));
    ...
    private static final long LogBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("LogBuffer"));
    ...
    private static final long LogNextPrefix$OFFSET = $LAYOUT.byteOffset(groupElement("LogNextPrefix"));
    ...
    private static final long LogNextSuffix$OFFSET = $LAYOUT.byteOffset(groupElement("LogNextSuffix"));
    ...
    private static final long LogLinePosY$OFFSET = $LAYOUT.byteOffset(groupElement("LogLinePosY"));
    ...
    private static final long LogDepthRef$OFFSET = $LAYOUT.byteOffset(groupElement("LogDepthRef"));
    ...
    private static final long LogDepthToExpand$OFFSET = $LAYOUT.byteOffset(groupElement("LogDepthToExpand"));
    ...
    private static final long LogDepthToExpandDefault$OFFSET = $LAYOUT.byteOffset(groupElement("LogDepthToExpandDefault"));
    ...
    private static final AddressLayout ErrorCallback$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("ErrorCallback"));
     ...
     * }
     */
    public static final AddressLayout ErrorCallback$layout() {
        return ErrorCallback$LAYOUT;
    }

    private static final long ErrorCallback$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorCallback"));
     ...
     * }
     */
    public static final long ErrorCallback$offset() {
        return ErrorCallback$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ErrorCallback(MemorySegment struct) {
        return struct.get(ErrorCallback$LAYOUT, ErrorCallback$OFFSET);
    }
     ...
     * }
     */
    public static void ErrorCallback(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(ErrorCallback$LAYOUT, ErrorCallback$OFFSET, fieldValue);
    }

    private static final AddressLayout ErrorCallbackUserData$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("ErrorCallbackUserData"));
     ...
     * }
     */
    public static final AddressLayout ErrorCallbackUserData$layout() {
        return ErrorCallbackUserData$LAYOUT;
    }

    private static final long ErrorCallbackUserData$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorCallbackUserData"));
     ...
     * }
     */
    public static final long ErrorCallbackUserData$offset() {
        return ErrorCallbackUserData$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ErrorCallbackUserData(MemorySegment struct) {
        return struct.get(ErrorCallbackUserData$LAYOUT, ErrorCallbackUserData$OFFSET);
    }
     ...
     * }
     */
    public static void ErrorCallbackUserData(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(ErrorCallbackUserData$LAYOUT, ErrorCallbackUserData$OFFSET, fieldValue);
    }

    private static final GroupLayout ErrorTooltipLockedPos$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("ErrorTooltipLockedPos"));
     ...
     * }
     */
    public static final GroupLayout ErrorTooltipLockedPos$layout() {
        return ErrorTooltipLockedPos$LAYOUT;
    }

    private static final long ErrorTooltipLockedPos$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorTooltipLockedPos"));
     ...
     * }
     */
    public static final long ErrorTooltipLockedPos$offset() {
        return ErrorTooltipLockedPos$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ErrorTooltipLockedPos(MemorySegment struct) {
        return struct.asSlice(ErrorTooltipLockedPos$OFFSET, ErrorTooltipLockedPos$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void ErrorTooltipLockedPos(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, ErrorTooltipLockedPos$OFFSET, ErrorTooltipLockedPos$LAYOUT.byteSize());
    }

    private static final OfBoolean ErrorFirst$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("ErrorFirst"));
     ...
     * }
     */
    public static final OfBoolean ErrorFirst$layout() {
        return ErrorFirst$LAYOUT;
    }

    private static final long ErrorFirst$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorFirst"));
     ...
     * }
     */
    public static final long ErrorFirst$offset() {
        return ErrorFirst$OFFSET;
    }
     ...
     * }
     */
    public static boolean ErrorFirst(MemorySegment struct) {
        return struct.get(ErrorFirst$LAYOUT, ErrorFirst$OFFSET);
    }
     ...
     * }
     */
    public static void ErrorFirst(MemorySegment struct, boolean fieldValue) {
        struct.set(ErrorFirst$LAYOUT, ErrorFirst$OFFSET, fieldValue);
    }

    private static final OfInt ErrorCountCurrentFrame$LAYOUT = (OfInt)$LAYOUT.select(groupElement("ErrorCountCurrentFrame"));
     ...
     * }
     */
    public static final OfInt ErrorCountCurrentFrame$layout() {
        return ErrorCountCurrentFrame$LAYOUT;
    }

    private static final long ErrorCountCurrentFrame$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorCountCurrentFrame"));
     ...
     * }
     */
    public static final long ErrorCountCurrentFrame$offset() {
        return ErrorCountCurrentFrame$OFFSET;
    }
     ...
     * }
     */
    public static int ErrorCountCurrentFrame(MemorySegment struct) {
        return struct.get(ErrorCountCurrentFrame$LAYOUT, ErrorCountCurrentFrame$OFFSET);
    }
     ...
     * }
     */
    public static void ErrorCountCurrentFrame(MemorySegment struct, int fieldValue) {
        struct.set(ErrorCountCurrentFrame$LAYOUT, ErrorCountCurrentFrame$OFFSET, fieldValue);
    }

    private static final GroupLayout StackSizesInNewFrame$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("StackSizesInNewFrame"));
     ...
     * }
     */
    public static final GroupLayout StackSizesInNewFrame$layout() {
        return StackSizesInNewFrame$LAYOUT;
    }

    private static final long StackSizesInNewFrame$OFFSET = $LAYOUT.byteOffset(groupElement("StackSizesInNewFrame"));
     ...
     * }
     */
    public static final long StackSizesInNewFrame$offset() {
        return StackSizesInNewFrame$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment StackSizesInNewFrame(MemorySegment struct) {
        return struct.asSlice(StackSizesInNewFrame$OFFSET, StackSizesInNewFrame$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void StackSizesInNewFrame(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, StackSizesInNewFrame$OFFSET, StackSizesInNewFrame$LAYOUT.byteSize());
    }

    private static final AddressLayout StackSizesInBeginForCurrentWindow$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("StackSizesInBeginForCurrentWindow"));
     ...
     * }
     */
    public static final AddressLayout StackSizesInBeginForCurrentWindow$layout() {
        return StackSizesInBeginForCurrentWindow$LAYOUT;
    }

    private static final long StackSizesInBeginForCurrentWindow$OFFSET = $LAYOUT.byteOffset(groupElement("StackSizesInBeginForCurrentWindow"));
     ...
     * }
     */
    public static final long StackSizesInBeginForCurrentWindow$offset() {
        return StackSizesInBeginForCurrentWindow$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment StackSizesInBeginForCurrentWindow(MemorySegment struct) {
        return struct.get(StackSizesInBeginForCurrentWindow$LAYOUT, StackSizesInBeginForCurrentWindow$OFFSET);
    }
     ...
     * }
     */
    public static void StackSizesInBeginForCurrentWindow(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(StackSizesInBeginForCurrentWindow$LAYOUT, StackSizesInBeginForCurrentWindow$OFFSET, fieldValue);
    }

    private static final OfInt DebugDrawIdConflictsCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DebugDrawIdConflictsCount"));
     ...
     * }
     */
    public static final OfInt DebugDrawIdConflictsCount$layout() {
        return DebugDrawIdConflictsCount$LAYOUT;
    }

    private static final long DebugDrawIdConflictsCount$OFFSET = $LAYOUT.byteOffset(groupElement("DebugDrawIdConflictsCount"));
     ...
     * }
     */
    public static final long DebugDrawIdConflictsCount$offset() {
        return DebugDrawIdConflictsCount$OFFSET;
    }
     ...
     * }
     */
    public static int DebugDrawIdConflictsCount(MemorySegment struct) {
        return struct.get(DebugDrawIdConflictsCount$LAYOUT, DebugDrawIdConflictsCount$OFFSET);
    }
     ...
     * }
     */
    public static void DebugDrawIdConflictsCount(MemorySegment struct, int fieldValue) {
        struct.set(DebugDrawIdConflictsCount$LAYOUT, DebugDrawIdConflictsCount$OFFSET, fieldValue);
    }
    ...
    private static final long DebugLogFlags$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogFlags"));
    ...
    private static final long DebugLogBuf$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogBuf"));
    ...
    private static final long DebugLogIndex$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogIndex"));
    ...
    private static final OfInt DebugLogSkippedErrors$LAYOUT = (OfInt)$LAYOUT.select(groupElement("DebugLogSkippedErrors"));
     ...
     * }
     */
    public static final OfInt DebugLogSkippedErrors$layout() {
        return DebugLogSkippedErrors$LAYOUT;
    }

    private static final long DebugLogSkippedErrors$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogSkippedErrors"));
     ...
     * }
     */
    public static final long DebugLogSkippedErrors$offset() {
        return DebugLogSkippedErrors$OFFSET;
    }
     ...
     * }
     */
    public static int DebugLogSkippedErrors(MemorySegment struct) {
        return struct.get(DebugLogSkippedErrors$LAYOUT, DebugLogSkippedErrors$OFFSET);
    }
     ...
     * }
     */
    public static void DebugLogSkippedErrors(MemorySegment struct, int fieldValue) {
        struct.set(DebugLogSkippedErrors$LAYOUT, DebugLogSkippedErrors$OFFSET, fieldValue);
    }
    ...
    private static final long DebugLogAutoDisableFlags$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogAutoDisableFlags"));
    ...
    private static final long DebugLogAutoDisableFrames$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLogAutoDisableFrames"));
    ...
    private static final long DebugLocateFrames$OFFSET = $LAYOUT.byteOffset(groupElement("DebugLocateFrames"));
    ...
    private static final long DebugBreakInLocateId$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBreakInLocateId"));
    ...
    private static final long DebugBreakKeyChord$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBreakKeyChord"));
    ...
    private static final long DebugBeginReturnValueCullDepth$OFFSET = $LAYOUT.byteOffset(groupElement("DebugBeginReturnValueCullDepth"));
    ...
    private static final long DebugItemPickerActive$OFFSET = $LAYOUT.byteOffset(groupElement("DebugItemPickerActive"));
    ...
    private static final long DebugItemPickerMouseButton$OFFSET = $LAYOUT.byteOffset(groupElement("DebugItemPickerMouseButton"));
    ...
    private static final long DebugItemPickerBreakId$OFFSET = $LAYOUT.byteOffset(groupElement("DebugItemPickerBreakId"));
    ...
    private static final long DebugFlashStyleColorTime$OFFSET = $LAYOUT.byteOffset(groupElement("DebugFlashStyleColorTime"));
    ...
    private static final long DebugFlashStyleColorBackup$OFFSET = $LAYOUT.byteOffset(groupElement("DebugFlashStyleColorBackup"));
    ...
    private static final long DebugMetricsConfig$OFFSET = $LAYOUT.byteOffset(groupElement("DebugMetricsConfig"));
    ...
    private static final GroupLayout DebugItemPathQuery$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("DebugItemPathQuery"));
     ...
     * }
     */
    public static final GroupLayout DebugItemPathQuery$layout() {
        return DebugItemPathQuery$LAYOUT;
    }

    private static final long DebugItemPathQuery$OFFSET = $LAYOUT.byteOffset(groupElement("DebugItemPathQuery"));
     ...
     * }
     */
    public static final long DebugItemPathQuery$offset() {
        return DebugItemPathQuery$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment DebugItemPathQuery(MemorySegment struct) {
        return struct.asSlice(DebugItemPathQuery$OFFSET, DebugItemPathQuery$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void DebugItemPathQuery(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, DebugItemPathQuery$OFFSET, DebugItemPathQuery$LAYOUT.byteSize());
    }
    ...
    private static final long DebugIDStackTool$OFFSET = $LAYOUT.byteOffset(groupElement("DebugIDStackTool"));
    ...
    private static final long DebugAllocInfo$OFFSET = $LAYOUT.byteOffset(groupElement("DebugAllocInfo"));
    ...
    private static final long FramerateSecPerFrame$OFFSET = $LAYOUT.byteOffset(groupElement("FramerateSecPerFrame"));
    ...
    public static float FramerateSecPerFrame(MemorySegment struct, long index0) {
        return (float)FramerateSecPerFrame$ELEM_HANDLE.get(struct, FramerateSecPerFrame$OFFSET, index0);
    }
    ...
    public static void FramerateSecPerFrame(MemorySegment struct, long index0, float fieldValue) {
        FramerateSecPerFrame$ELEM_HANDLE.set(struct, FramerateSecPerFrame$OFFSET, index0, fieldValue);
    }
    ...
    private static final long FramerateSecPerFrameIdx$OFFSET = $LAYOUT.byteOffset(groupElement("FramerateSecPerFrameIdx"));
    ...
    private static final long FramerateSecPerFrameCount$OFFSET = $LAYOUT.byteOffset(groupElement("FramerateSecPerFrameCount"));
    ...
    private static final long FramerateSecPerFrameAccum$OFFSET = $LAYOUT.byteOffset(groupElement("FramerateSecPerFrameAccum"));
    ...
    private static final long WantCaptureMouseNextFrame$OFFSET = $LAYOUT.byteOffset(groupElement("WantCaptureMouseNextFrame"));
    ...
    private static final long WantCaptureKeyboardNextFrame$OFFSET = $LAYOUT.byteOffset(groupElement("WantCaptureKeyboardNextFrame"));
    ...
    private static final long WantTextInputNextFrame$OFFSET = $LAYOUT.byteOffset(groupElement("WantTextInputNextFrame"));
    ...
    private static final long TempKeychordName$OFFSET = $LAYOUT.byteOffset(groupElement("TempKeychordName"));
    ...
    public static byte TempKeychordName(MemorySegment struct, long index0) {
        return (byte)TempKeychordName$ELEM_HANDLE.get(struct, TempKeychordName$OFFSET, index0);
    }
    ...
    public static void TempKeychordName(MemorySegment struct, long index0, byte fieldValue) {
        TempKeychordName$ELEM_HANDLE.set(struct, TempKeychordName$OFFSET, index0, fieldValue);
    }
