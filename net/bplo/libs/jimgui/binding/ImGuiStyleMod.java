...
public class ImGuiStyleMod {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("VarIdx"),
        MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(2, cimgui_h.C_INT).withName("BackupInt"),
            MemoryLayout.sequenceLayout(2, cimgui_h.C_FLOAT).withName("BackupFloat")
        ).withName("$anon$1820:5")
    ...
    private static final long VarIdx$OFFSET = $LAYOUT.byteOffset(groupElement("VarIdx"));
    ...
    private static final SequenceLayout BackupInt$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$1820:5"), groupElement("BackupInt"));
    ...
    private static final long BackupInt$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1820:5"), groupElement("BackupInt"));
    ...
    public static int BackupInt(MemorySegment struct, long index0) {
        return (int)BackupInt$ELEM_HANDLE.get(struct, BackupInt$OFFSET, index0);
    }
    ...
    public static void BackupInt(MemorySegment struct, long index0, int fieldValue) {
        BackupInt$ELEM_HANDLE.set(struct, BackupInt$OFFSET, index0, fieldValue);
    }

    private static final SequenceLayout BackupFloat$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$1820:5"), groupElement("BackupFloat"));
    ...
    private static final long BackupFloat$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1820:5"), groupElement("BackupFloat"));
    ...
    public static float BackupFloat(MemorySegment struct, long index0) {
        return (float)BackupFloat$ELEM_HANDLE.get(struct, BackupFloat$OFFSET, index0);
    }
    ...
    public static void BackupFloat(MemorySegment struct, long index0, float fieldValue) {
        BackupFloat$ELEM_HANDLE.set(struct, BackupFloat$OFFSET, index0, fieldValue);
    }
