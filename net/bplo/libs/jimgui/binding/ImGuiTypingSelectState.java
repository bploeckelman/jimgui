...
public class ImGuiTypingSelectState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(64, cimgui_h.C_CHAR).withName("SearchBuffer"),
        cimgui_h.C_INT.withName("FocusScope"),
        cimgui_h.C_INT.withName("LastRequestFrame"),
        cimgui_h.C_FLOAT.withName("LastRequestTime"),
        cimgui_h.C_BOOL.withName("SingleCharModeLock"),
    ...
    private static final long Request$OFFSET = $LAYOUT.byteOffset(groupElement("Request"));
    ...
    private static final long SearchBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("SearchBuffer"));
    ...
    public static byte SearchBuffer(MemorySegment struct, long index0) {
        return (byte)SearchBuffer$ELEM_HANDLE.get(struct, SearchBuffer$OFFSET, index0);
    }
    ...
    public static void SearchBuffer(MemorySegment struct, long index0, byte fieldValue) {
        SearchBuffer$ELEM_HANDLE.set(struct, SearchBuffer$OFFSET, index0, fieldValue);
    }
    ...
    private static final long FocusScope$OFFSET = $LAYOUT.byteOffset(groupElement("FocusScope"));
    ...
    private static final long LastRequestFrame$OFFSET = $LAYOUT.byteOffset(groupElement("LastRequestFrame"));
    ...
    private static final long LastRequestTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastRequestTime"));
    ...
    private static final long SingleCharModeLock$OFFSET = $LAYOUT.byteOffset(groupElement("SingleCharModeLock"));
