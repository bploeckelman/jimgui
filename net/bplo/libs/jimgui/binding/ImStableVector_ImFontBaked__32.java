 ...
 * }
 */
public class ImStableVector_ImFontBaked__32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cimgui_h.C_INT.withName("Capacity"),
        ImVector_ImFontBakedPtr.layout().withName("Blocks")
    ).withName("ImStableVector_ImFontBaked__32");
    ...
    private static final GroupLayout Blocks$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Blocks"));
     ...
     * }
     */
    public static final GroupLayout Blocks$layout() {
