 ...
 * }
 */
public class ImGuiErrorRecoveryState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_SHORT.withName("SizeOfWindowStack"),
        cimgui_h.C_SHORT.withName("SizeOfIDStack"),
        cimgui_h.C_SHORT.withName("SizeOfTreeStack"),
        cimgui_h.C_SHORT.withName("SizeOfColorStack"),
        cimgui_h.C_SHORT.withName("SizeOfStyleVarStack"),
        cimgui_h.C_SHORT.withName("SizeOfFontStack"),
        cimgui_h.C_SHORT.withName("SizeOfFocusScopeStack"),
        cimgui_h.C_SHORT.withName("SizeOfGroupStack"),
        cimgui_h.C_SHORT.withName("SizeOfItemFlagsStack"),
        cimgui_h.C_SHORT.withName("SizeOfBeginPopupStack"),
        cimgui_h.C_SHORT.withName("SizeOfDisabledStack")
    ).withName("ImGuiErrorRecoveryState");
    ...
    private static final OfShort SizeOfWindowStack$LAYOUT = (OfShort)$LAYOUT.select(groupElement("SizeOfWindowStack"));
     ...
     * }
     */
    public static final OfShort SizeOfWindowStack$layout() {
        return SizeOfWindowStack$LAYOUT;
    }

    private static final long SizeOfWindowStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfWindowStack"));
     ...
     * }
     */
    public static final long SizeOfWindowStack$offset() {
        return SizeOfWindowStack$OFFSET;
    }
     ...
     * }
     */
    public static short SizeOfWindowStack(MemorySegment struct) {
        return struct.get(SizeOfWindowStack$LAYOUT, SizeOfWindowStack$OFFSET);
    }
     ...
     * }
     */
    public static void SizeOfWindowStack(MemorySegment struct, short fieldValue) {
        struct.set(SizeOfWindowStack$LAYOUT, SizeOfWindowStack$OFFSET, fieldValue);
    }
    ...
    private static final long SizeOfIDStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfIDStack"));
    ...
    private static final OfShort SizeOfTreeStack$LAYOUT = (OfShort)$LAYOUT.select(groupElement("SizeOfTreeStack"));
     ...
     * }
     */
    public static final OfShort SizeOfTreeStack$layout() {
        return SizeOfTreeStack$LAYOUT;
    }

    private static final long SizeOfTreeStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfTreeStack"));
     ...
     * }
     */
    public static final long SizeOfTreeStack$offset() {
        return SizeOfTreeStack$OFFSET;
    }
     ...
     * }
     */
    public static short SizeOfTreeStack(MemorySegment struct) {
        return struct.get(SizeOfTreeStack$LAYOUT, SizeOfTreeStack$OFFSET);
    }
     ...
     * }
     */
    public static void SizeOfTreeStack(MemorySegment struct, short fieldValue) {
        struct.set(SizeOfTreeStack$LAYOUT, SizeOfTreeStack$OFFSET, fieldValue);
    }
    ...
    private static final long SizeOfColorStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfColorStack"));
    ...
    private static final long SizeOfStyleVarStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfStyleVarStack"));
    ...
    private static final long SizeOfFontStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfFontStack"));
    ...
    private static final long SizeOfFocusScopeStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfFocusScopeStack"));
    ...
    private static final long SizeOfGroupStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfGroupStack"));
    ...
    private static final long SizeOfItemFlagsStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfItemFlagsStack"));
    ...
    private static final long SizeOfBeginPopupStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfBeginPopupStack"));
    ...
    private static final long SizeOfDisabledStack$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfDisabledStack"));
