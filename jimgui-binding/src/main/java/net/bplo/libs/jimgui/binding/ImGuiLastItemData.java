...
public class ImGuiLastItemData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cimgui_h.C_INT.withName("StatusFlags"),
        ImRect_c.layout().withName("Rect"),
        ImRect_c.layout().withName("NavRect"),
        ImRect_c.layout().withName("DisplayRect"),
    ...
    private static final long StatusFlags$OFFSET = $LAYOUT.byteOffset(groupElement("StatusFlags"));
    ...
    private static final long DisplayRect$OFFSET = $LAYOUT.byteOffset(groupElement("DisplayRect"));
