...
public class ImGuiInputTextCallbackData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cimgui_h.C_INT.withName("EventFlag"),
        cimgui_h.C_INT.withName("Flags"),
        cimgui_h.C_POINTER.withName("UserData"),
        cimgui_h.C_INT.withName("ID"),
        cimgui_h.C_INT.withName("EventKey"),
        cimgui_h.C_SHORT.withName("EventChar"),
        cimgui_h.C_BOOL.withName("EventActivated"),
        cimgui_h.C_BOOL.withName("BufDirty"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("Buf"),
        cimgui_h.C_INT.withName("BufTextLen"),
        cimgui_h.C_INT.withName("BufSize"),
        cimgui_h.C_INT.withName("CursorPos"),
        cimgui_h.C_INT.withName("SelectionStart"),
        cimgui_h.C_INT.withName("SelectionEnd"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long EventFlag$OFFSET = $LAYOUT.byteOffset(groupElement("EventFlag"));
    ...
    private static final long EventKey$OFFSET = $LAYOUT.byteOffset(groupElement("EventKey"));
    ...
    private static final long EventChar$OFFSET = $LAYOUT.byteOffset(groupElement("EventChar"));
    ...
    private static final OfBoolean EventActivated$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("EventActivated"));
     ...
     * }
     */
    public static final OfBoolean EventActivated$layout() {
        return EventActivated$LAYOUT;
    }

    private static final long EventActivated$OFFSET = $LAYOUT.byteOffset(groupElement("EventActivated"));
     ...
     * }
     */
    public static final long EventActivated$offset() {
        return EventActivated$OFFSET;
    }
     ...
     * }
     */
    public static boolean EventActivated(MemorySegment struct) {
        return struct.get(EventActivated$LAYOUT, EventActivated$OFFSET);
    }
     ...
     * }
     */
    public static void EventActivated(MemorySegment struct, boolean fieldValue) {
        struct.set(EventActivated$LAYOUT, EventActivated$OFFSET, fieldValue);
    }
    ...
    private static final long BufDirty$OFFSET = $LAYOUT.byteOffset(groupElement("BufDirty"));
    ...
    private static final long BufTextLen$OFFSET = $LAYOUT.byteOffset(groupElement("BufTextLen"));
    ...
    private static final long BufSize$OFFSET = $LAYOUT.byteOffset(groupElement("BufSize"));
    ...
    private static final long SelectionStart$OFFSET = $LAYOUT.byteOffset(groupElement("SelectionStart"));
    ...
    private static final long SelectionEnd$OFFSET = $LAYOUT.byteOffset(groupElement("SelectionEnd"));
