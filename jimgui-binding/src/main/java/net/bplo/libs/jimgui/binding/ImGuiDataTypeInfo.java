...
public class ImGuiDataTypeInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_LONG_LONG.withName("Size"),
        cimgui_h.C_POINTER.withName("Name"),
        cimgui_h.C_POINTER.withName("PrintFmt"),
        cimgui_h.C_POINTER.withName("ScanFmt")
    ...
    private static final long PrintFmt$OFFSET = $LAYOUT.byteOffset(groupElement("PrintFmt"));
    ...
    private static final long ScanFmt$OFFSET = $LAYOUT.byteOffset(groupElement("ScanFmt"));
