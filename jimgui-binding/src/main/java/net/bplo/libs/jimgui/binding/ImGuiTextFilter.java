...
public class ImGuiTextFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(256, cimgui_h.C_CHAR).withName("InputBuf"),
        ImVector_ImGuiTextRange.layout().withName("Filters"),
        cimgui_h.C_INT.withName("CountGrep"),
    ...
    private static final long InputBuf$OFFSET = $LAYOUT.byteOffset(groupElement("InputBuf"));
    ...
    public static byte InputBuf(MemorySegment struct, long index0) {
        return (byte)InputBuf$ELEM_HANDLE.get(struct, InputBuf$OFFSET, index0);
    }
    ...
    public static void InputBuf(MemorySegment struct, long index0, byte fieldValue) {
        InputBuf$ELEM_HANDLE.set(struct, InputBuf$OFFSET, index0, fieldValue);
    }
    ...
    private static final long CountGrep$OFFSET = $LAYOUT.byteOffset(groupElement("CountGrep"));
