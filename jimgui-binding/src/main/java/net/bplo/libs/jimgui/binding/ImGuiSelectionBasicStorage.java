...
public class ImGuiSelectionBasicStorage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("Size"),
        cimgui_h.C_BOOL.withName("PreserveOrder"),
        MemoryLayout.paddingLayout(3),
        cimgui_h.C_POINTER.withName("UserData"),
        cimgui_h.C_POINTER.withName("AdapterIndexToStorageId"),
        cimgui_h.C_INT.withName("_SelectionOrder"),
    ...
    private static final long PreserveOrder$OFFSET = $LAYOUT.byteOffset(groupElement("PreserveOrder"));
     ...
     * }
     */
    public final static class AdapterIndexToStorageId {

        private AdapterIndexToStorageId() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cimgui_h.upcallHandle(AdapterIndexToStorageId.Function.class, "apply", $DESC);
    ...
    private static final long AdapterIndexToStorageId$OFFSET = $LAYOUT.byteOffset(groupElement("AdapterIndexToStorageId"));
    ...
    private static final long _SelectionOrder$OFFSET = $LAYOUT.byteOffset(groupElement("_SelectionOrder"));
    ...
    private static final long _Storage$OFFSET = $LAYOUT.byteOffset(groupElement("_Storage"));
