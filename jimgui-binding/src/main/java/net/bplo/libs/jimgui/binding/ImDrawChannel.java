...
public class ImDrawChannel {
    ...
    private static final long _CmdBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("_CmdBuffer"));
    ...
    private static final long _IdxBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("_IdxBuffer"));
