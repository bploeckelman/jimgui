...
public class ImGuiTableColumnSettings {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_FLOAT.withName("WidthOrWeight"),
        cimgui_h.C_INT.withName("UserID"),
        cimgui_h.C_SHORT.withName("Index"),
    ...
    private static final long WidthOrWeight$OFFSET = $LAYOUT.byteOffset(groupElement("WidthOrWeight"));
