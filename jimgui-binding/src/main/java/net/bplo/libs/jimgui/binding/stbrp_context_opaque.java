 ...
 * }
 */
public class stbrp_context_opaque {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(80, cimgui_h.C_CHAR).withName("data")
    ).withName("stbrp_context_opaque");
    ...
    private static long[] data$DIMS = { 80 };
