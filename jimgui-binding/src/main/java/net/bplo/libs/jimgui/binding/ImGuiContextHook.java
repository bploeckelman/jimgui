...
public class ImGuiContextHook {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_INT.withName("HookId"),
        cimgui_h.C_INT.withName("Type"),
        cimgui_h.C_INT.withName("Owner"),
        MemoryLayout.paddingLayout(4),
        cimgui_h.C_POINTER.withName("Callback"),
    ...
    private static final long HookId$OFFSET = $LAYOUT.byteOffset(groupElement("HookId"));
