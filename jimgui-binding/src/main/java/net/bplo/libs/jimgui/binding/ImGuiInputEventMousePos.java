...
public class ImGuiInputEventMousePos {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cimgui_h.C_FLOAT.withName("PosX"),
        cimgui_h.C_FLOAT.withName("PosY"),
    ...
    private static final long PosX$OFFSET = $LAYOUT.byteOffset(groupElement("PosX"));
    ...
    private static final long PosY$OFFSET = $LAYOUT.byteOffset(groupElement("PosY"));
