...
public class ImGuiKeyRoutingTable {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(155, cimgui_h.C_SHORT).withName("Index"),
    ...
    private static long[] Index$DIMS = { 155 };
    ...
    public static short Index(MemorySegment struct, long index0) {
        return (short)Index$ELEM_HANDLE.get(struct, Index$OFFSET, index0);
    }
    ...
    private static final long EntriesNext$OFFSET = $LAYOUT.byteOffset(groupElement("EntriesNext"));
